...
public class HtmlValidator {
    ...
    protected String[] ignores = { "<header>", "<nav>", "<section>", "<article>", "<aside>", "<selectize>", "</selectize>", "<footer>", "</header>", "</nav>","<svg>","</svg>","<use>","</use>",
            ...
            "Error: autcomplete is not recognized",
            "Error: institution is not recognized",
            "Error: person is not recognized",
            "Error: tagbox is not recognized",
            "Warning: missing </div> before <style>",
            "missing </form> before </div",
