...
//        wc.setDataTableSupported(true);
        ...
        wc.getOriginalFile().getParts().add(FileStoreFileUtils.copyVersionToFilestoreFile(supportingFile));
    ...
    public void testPolyShapeWithData() throws Exception {
        ...
        for (String ext : new String[] { ".dbf", ".sbn", ".sbx", ".shp.xml", ".shx", ".xml" }) {
            ...
            wc.getOriginalFile().getParts().add(FileStoreFileUtils.copyVersionToFilestoreFile(originalVersion));
    ...
    public void testFAIMSKML() throws Exception {
        ...
        // }
        wc.setOriginalFile(FileStoreFileUtils.copyVersionToFilestoreFile(originalVersion));
        task.setWorkflowContext(wc);
        task.run();
    }
