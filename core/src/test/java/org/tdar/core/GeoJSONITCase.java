...
public class GeoJSONITCase extends AbstractIntegrationTestCase {
    ...
    private void assertObfuscated(Resource res, String result, String r1, boolean obfuscated) {
        Double minLatitude = res.getFirstActiveLatitudeLongitudeBox().getMinimumLatitude();
        Double maxLatitude = res.getFirstActiveLatitudeLongitudeBox().getMaximumLatitude();
    ...
    private Resource[] setupDocs() throws InstantiationException, IllegalAccessException {
        ...
        llb.setMaximumLatitude(llb.getMinimumLatitude());
        llb.setMaximumLongitude(llb.getMinimumLongitude());
