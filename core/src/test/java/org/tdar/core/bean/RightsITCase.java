...
//        au.setDateExpires(soon);
    ...
    public void testRightsRemoveInherit() {
        ...
        resourceCollectionService.updateCollectionParentTo(getAdminUser(), parent, grandParent, SharedCollection.class);
        resourceCollectionService.updateCollectionParentTo(getAdminUser(), collection, parent, SharedCollection.class);
        genericService.saveOrUpdate(grandParent);
        genericService.saveOrUpdate(parent);
        genericService.saveOrUpdate(collection);
