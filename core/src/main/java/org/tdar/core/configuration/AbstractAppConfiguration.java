...
@PropertySource(value = "file://${TDAR_CONFIG_PATH}/" + AbstractAppConfiguration.HIBERNATE_PROPERTIES, ignoreResourceNotFound = true)
...
@PropertySource(value = "file://${TDAR_CONFIG_PATH}/" + AbstractAppConfiguration.TDAR_PROPERTIES, ignoreResourceNotFound = true)
