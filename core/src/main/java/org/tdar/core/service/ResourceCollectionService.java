...
public class ResourceCollectionService extends ServiceInterface.TypedDaoBase<ResourceCollection, ResourceCollectionDao> {
    ...
    private Collection<ResourceCollection> addAlternateChildrenTrees(Collection<ResourceCollection> allChildren, ResourceCollection collection) {
        Set<ResourceCollection> toReturn = new HashSet<>(getDao().getAlternateChildrenTrees(allChildren, collection)); 
        return toReturn;
    }
