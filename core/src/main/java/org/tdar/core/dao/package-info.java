...
@org.hibernate.annotations.NamedQueries({
        ...
        @org.hibernate.annotations.NamedQuery(
                ...
                query = "select rescol from RightsBasedResourceCollection rescol join rescol.authorizedUsers  as authUser where authUser.effectiveGeneralPermission > :effectivePermission  and authUser.user.id = :userId"),
