...
public class NelNetTransactionResponseTemplate implements Serializable, TransactionResponse {
    ...
    public enum NelnetTransactionItemResponse {
        ...
        TRANSACTION_SOURCE(
                "transactionSource", "transactionSource", 3),
        ...
        TRANSACTION_ACCOUNT_TYPE("transactionAcountType",
                "transactionAcountType", 9),
        TRANSACTION_EFFECTIVE_DATE("transactionEffectiveDate", "transactionEffectiveDate",
                10),
        TRANSACTION_DESCRIPTION("transactionDescription", "transactionDescription", 11),
        TRANSACTION_RESULT_DATE(
                "transactionResultDate", "transactionResultDate", 12),
        TRANSACTION_RESULT_EFFECTIVE_DATE(
                "transactionResultEffectiveDate", "transactionResultEffectiveDate",
                13),
        TRANSACTION_RESULT_CODE("transactionResultCode", "transactionResultCode",
                14),
        TRANSACTION_RESULT_MESSAGE("transactionResultMessage", "transactionResultMessage",
                15),
        ...
        ORDER_FEE(
                "orderFee", "orderFee",
                21),
        ORDER_DUE_DATE("orderDueDate", "orderDueDate",
                22),
        ORDER_AMOUNT_DUE("orderAmountDue",
                "orderAmountDue", 23),
        ORDER_BALANCE(
                "orderBalance", "orderBalance",
                24),
        ORDER_CURRENT_STATUS_BALANCE(
                "orderCurrentStatusBalance",
                "orderCurrentStatusBalance",
                25),
        ORDER_CURRENT_STATUS_AMOUNT_DUE(
        ...
        ACTUAL_PAYER_TYPE(
                ...
                "actualPayerType",
                30),
        ACTUAL_PAYER_IDENTIFIER(
                "actualPayerIdentifier",
                "actualPayerIdentifier",
                31),
        ACTUAL_PAYER_FULL_NAME(
                "actualPayerFullName",
                "actualPayerFullName",
                32),
        ACCOUNT_HOLDER_NAME(
