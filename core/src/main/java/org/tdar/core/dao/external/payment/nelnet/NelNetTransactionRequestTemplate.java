...
public class NelNetTransactionRequestTemplate implements Serializable {
    ...
    public enum NelnetTransactionItem {
        ...
        USER_CHOICE_3(14, "userChoice3", ItemType.STRING,
                50),
        USER_CHOICE_4(15, "userChoice4", ItemType.STRING, 50),
        USER_CHOICE_5(16, "userChoice5", ItemType.STRING,
                50),
        USER_CHOICE_6(17, "userChoice6", ItemType.STRING, 50),
        USER_CHOICE_7(18, "userChoice7",
                ItemType.STRING, 50),
        ...
        COUNTRY(28, "country",
                ItemType.STRING, 20),
        DAYTIME_PHONE(29, "daytimePhone",
                ItemType.STRING, 20),
        EVENING_PHONE(30,
                "eveningPhone", ItemType.STRING,
                20),
        EMAIL(31, "email", ItemType.STRING,
                50),
        TIMESTAMP(36, "timestamp",
                ItemType.TIMESTAMP,
                13),
        SECRET(400, null,
                ItemType.STRING,
