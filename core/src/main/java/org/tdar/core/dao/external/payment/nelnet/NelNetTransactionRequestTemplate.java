...
public class NelNetTransactionRequestTemplate implements Serializable {
    ...
    public enum ItemType {
        NUMERIC, DATE, TIMESTAMP, STRING, FLOAT;
    }
    ...
    public enum NelnetTransactionItem {
        ORDER_TYPE(1, "orderType", ItemType.STRING, 32), ORDER_NUMBER(2, "orderNumber", ItemType.STRING, 32), ORDER_NAME(3, "orderName", ItemType.STRING,
                32), ORDER_DESCRIPTION(4, "orderDescription", ItemType.STRING, 32), AMOUNT(5, "amount", ItemType.NUMERIC, 12), ORDER_FEE(6, "orderFee",
                        ItemType.NUMERIC,
                        12), AMOUNT_DUE(7, "amountDue", ItemType.NUMERIC, 12), CURRENT_AMOUNT_DUE(8, "currentAmountDue", ItemType.NUMERIC, 12), BALANCE(9,
                                "balance", ItemType.NUMERIC,
                                12), CURRENT_BALANCE(10, "currentBalance", ItemType.NUMERIC, 12), DUE_DATE(11, "dueDate", ItemType.DATE, 8), USER_CHOICE_1(12,
                                        "userChoice1", ItemType.STRING,
                                        50), USER_CHOICE_2(13, "userChoice2", ItemType.STRING, 50), USER_CHOICE_3(14, "userChoice3", ItemType.STRING,
                                                50), USER_CHOICE_4(15, "userChoice4", ItemType.STRING, 50), USER_CHOICE_5(16, "userChoice5", ItemType.STRING,
                                                        50), USER_CHOICE_6(17, "userChoice6", ItemType.STRING, 50), USER_CHOICE_7(18, "userChoice7",
                                                                ItemType.STRING, 50), USER_CHOICE_8(19, "userChoice8", ItemType.STRING, 50), USER_CHOICE_9(20,
                                                                        "userChoice9", ItemType.STRING,
                                                                        50), USER_CHOICE_10(21, "userChoice10", ItemType.STRING, 50), PAYMENT_METHOD(22,
                                                                                "paymentMethod", ItemType.STRING,
                                                                                6), STREET_ONE(23, "streetOne", ItemType.STRING, 50), STREET_TWO(24,
                                                                                        "streetTwo", ItemType.STRING,
                                                                                        50), CITY(25, "city", ItemType.STRING, 20), STATE(26, "state",
                                                                                                ItemType.STRING,
                                                                                                2), ZIP(27, "zip", ItemType.STRING, 10), COUNTRY(28, "country",
                                                                                                        ItemType.STRING, 20), DAYTIME_PHONE(29, "daytimePhone",
                                                                                                                ItemType.STRING, 20), EVENING_PHONE(30,
                                                                                                                        "eveningPhone", ItemType.STRING,
                                                                                                                        20), EMAIL(31, "email", ItemType.STRING,
                                                                                                                                50), TIMESTAMP(36, "timestamp",
                                                                                                                                        ItemType.TIMESTAMP,
                                                                                                                                        13), SECRET(400, null,
                                                                                                                                                ItemType.STRING,
                                                                                                                                                40), HASH(500,
