...
public interface TdarNamedQueries {
    ...
    String DAILY_RESOURCE_UPDATE_BOT = "INSERT INTO resource_access_day_agg (resource_id, year, month, date_accessed, count, bot) select resource_id, date_part('year', date_accessed), date_part('month', date_accessed), date_trunc('day',date_accessed), count(id) from resource_access_statistics where date_trunc('day',date_accessed)='%1$tF' and bot=true group by resource_id, date_part('year', date_accessed), date_part('month', date_accessed), date_trunc('day', date_accessed)";
