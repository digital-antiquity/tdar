...
public interface TdarNamedQueries {
    ...
    String COLLECTION_CONTENTS_SQL = "select resource_id from collection_resource  where collection_id =:collectionId or collection_id in (select collection_id from collection_parents where parent_id =:collectionId)";
