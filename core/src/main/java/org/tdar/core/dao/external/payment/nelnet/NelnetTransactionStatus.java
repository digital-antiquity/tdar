...
public enum NelnetTransactionStatus {
    ...
    CC_PAYMENT_ERROR(3, "Error credit card payment/refund (error)", TransactionStatus.TRANSACTION_FAILED),
    CC_PAYMENT_UNKNOWN(4, "Unknown credit card payment/refund (unknown)", TransactionStatus.TRANSACTION_FAILED),
    CHECK_PAYMENT_SUCCESS(5, "Accepted eCheck payment (successful)", TransactionStatus.TRANSACTION_SUCCESSFUL),
    CHECK_PAYMENT_POSTED(6, "Posted eCheck payment (successful)", TransactionStatus.TRANSACTION_SUCCESSFUL),
    CHECK_PAYMENT_RETURNED(7, "Returned eCheck payment (failed)", TransactionStatus.TRANSACTION_FAILED),
    CHECK_PAYMENT_NOC(8, "NOC eCheck payment (successful)", TransactionStatus.TRANSACTION_SUCCESSFUL);
