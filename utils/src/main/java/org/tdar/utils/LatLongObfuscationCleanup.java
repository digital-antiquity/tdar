 ...
 */
@Component
public class LatLongObfuscationCleanup {

    private static final transient Logger logger = LoggerFactory.getLogger(LatLongObfuscationCleanup.class);
    ...
    public static void main(String[] args) throws IOException {
        ...
        LatLongObfuscationCleanup importer = new LatLongObfuscationCleanup();
    ...
    private void cleanup() {
        for (LatitudeLongitudeBox llb : genericService.findAll(LatitudeLongitudeBox.class)) {
            genericService.saveOrUpdate(llb);
            logger.debug("{} {}", llb.getId(), llb);
        }
    }
