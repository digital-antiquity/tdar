...
public class OwlApiHierarchyParser implements OntologyParser {
    ...
    private final HashMap<OWLClass, Set<OWLClass>> owlHierarchyMap = new HashMap<>();
    private final HashMap<OWLClass, TOntologyNode> classNodeMap = new HashMap<>();
    ...
    public Map<OWLClass, TOntologyNode> getOwlClassNodeMap() {
        return classNodeMap;
    }
    ...
    @Override
    public List<TOntologyNode> generate() {
        int startIndex = 1;
        ...
        return new ArrayList<>(classNodeMap.values());
    }
    ...
    private int generateIntervalLabels(OWLClass owlClass, int index_) {
        ...
        TOntologyNode node = new TOntologyNode();
        ...
        while (iterator.hasNext()) {
            ...
            TOntologyNode parentNode = classNodeMap.get(parentClass);
