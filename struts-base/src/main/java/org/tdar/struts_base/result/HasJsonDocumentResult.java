...
public interface HasJsonDocumentResult {
    ...
    /** 
     * returns the java object that will be serialized to JSON.  Use this along with getJsonView to specify how jackson should filter or transform the result.  Alternately, use getJsonInputStream to define the exact json directly
     * @return
     */
