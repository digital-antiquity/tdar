...
INSERT INTO resource (status, id, access_counter, confidential, date_registered, description, resource_type, title, submitter_id, url) VALUES ('ACTIVE',1, 0,  false ,  '2008-04-15 13:33:21.962',  N'This project contains all of your independent data resources.  These are data resources that you have not explicitly associated with any project.',  N'PROJECT',  N'Admin''s Independent Resources', 8093, NULL);
INSERT INTO resource (status, id, access_counter, confidential, date_registered, description, resource_type, title, submitter_id, url) VALUES ('ACTIVE',3, 0,  false ,  '2008-04-15 13:33:21.962',  N'This project contains all of your independent data resources.  These are data resources that you have not explicitly associated with any project.',  N'PROJECT',  N'Test''s Independent Resources', 8092, NULL);
INSERT INTO project (id) VALUES (1);
INSERT INTO project (id) VALUES (3);
--- ADD RESOURCE IDs TO EXTRACT OUT FROM tdarmetadata.zip
--------------------------- category_variable ---------------------------
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (4, NULL,  N'Provenience and Context',  N'CATEGORY', 4, NULL,  N'Provenience_and_Context');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (47, NULL,  N'Ceramics',  N'CATEGORY', 47, NULL,  N'Ceramics');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (48, NULL,  N'Chipped Stone',  N'CATEGORY', 48, NULL,  N'Chipped_Stone');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (49, NULL,  N'Ground Stone',  N'CATEGORY', 49, NULL,  N'Ground_Stone');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (50, NULL,  N'Minerals',  N'CATEGORY', 50, NULL,  N'Minerals');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (51, NULL,  N'Architecture',  N'CATEGORY', 51, NULL,  N'Architecture');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (52, NULL,  N'Human Skeletal',  N'CATEGORY', 52, NULL,  N'Human_Skeletal');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (53, NULL,  N'Burial',  N'CATEGORY', 53, NULL,  N'Burial');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (55, NULL,  N'Historic Artifacts',  N'CATEGORY', 55, NULL,  N'Historic_Artifacts');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (56, NULL,  N'Macrobotanical',  N'CATEGORY', 56, NULL,  N'Macrobotanical');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (57, NULL,  N'Pollen',  N'CATEGORY', 57, NULL,  N'Pollen');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (58, NULL,  N'Figurine',  N'CATEGORY', 58, NULL,  N'Figurine');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (59, NULL,  N'Shell',  N'CATEGORY', 59, NULL,  N'Shell');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (60, NULL,  N'Lookup',  N'CATEGORY', 60, NULL,  N'Lookup');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (61, NULL,  N'Dating Sample',  N'CATEGORY', 61, NULL,  N'Dating_Sample');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (0, NULL,  N'Fauna',  N'CATEGORY', 0, NULL,  N'Fauna');
--------------------------- category_variable ---------------------------
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (1, NULL,  N'Modification',  N'SUBCATEGORY', 4,  N'4',  N'Modification');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (2, NULL,  N'Natural Modification',  N'SUBCATEGORY', 4,  N'4',  N'Natural_Modification');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (3, NULL,  N'Cultural Modification',  N'SUBCATEGORY', 4,  N'4',  N'Cultural_Modification');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (5, NULL,  N'Horizontal Location',  N'SUBCATEGORY', 4,  N'4',  N'Horizontal_Location');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (6, NULL,  N'Vertical Position',  N'SUBCATEGORY', 4,  N'4',  N'Vertical_Position');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (7, NULL,  N'Recovery Method',  N'SUBCATEGORY', 4,  N'4',  N'Recovery_Method');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (8, NULL,  N'Element',  N'SUBCATEGORY', 0,  N'0',  N'Element');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (9, NULL,  N'Taxon',  N'SUBCATEGORY', 0,  N'0',  N'Taxon');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (10, NULL,  N'Side',  N'SUBCATEGORY', 0,  N'0',  N'Side');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (11, NULL,  N'Portion',  N'SUBCATEGORY', 0,  N'0',  N'Portion');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (12, NULL,  N'Proximal/Distal',  N'SUBCATEGORY', 0,  N'0',  N'Proximal_Distal');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (13, NULL,  N'Dorsal/Ventral',  N'SUBCATEGORY', 0,  N'0',  N'Dorsal_Ventral');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (14, NULL,  N'Fusion',  N'SUBCATEGORY', 0,  N'0',  N'Fusion');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (15, NULL,  N'Weight',  N'SUBCATEGORY', 0,  N'0',  N'Weight');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (16, NULL,  N'Length',  N'SUBCATEGORY', 0,  N'0',  N'Length');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (17, NULL,  N'Count',  N'SUBCATEGORY', 0,  N'0',  N'Count');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (18, NULL,  N'Minimum Count',  N'SUBCATEGORY', 0,  N'0',  N'Minimum_Count');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (19, NULL,  N'Maximum Count',  N'SUBCATEGORY', 0,  N'0',  N'Maximum_Count');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (20, NULL,  N'% Complete',  N'SUBCATEGORY', 0,  N'0',  N'Percent_Complete');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (21, NULL,  N'Completeness',  N'SUBCATEGORY', 0,  N'0',  N'Completeness');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (22, NULL,  N'Breakage',  N'SUBCATEGORY', 0,  N'0',  N'Breakage');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (23, NULL,  N'Animal Modification',  N'SUBCATEGORY', 2,  N'0.1.2',  N'Animal_Modification');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (24, NULL,  N'Gnawing',  N'SUBCATEGORY', 2,  N'0.1.2',  N'Gnawing');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (25, NULL,  N'Digestion',  N'SUBCATEGORY', 2,  N'0.1.2',  N'Digestion');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (26, NULL,  N'Weathering',  N'SUBCATEGORY', 2,  N'0.1.2',  N'Weathering');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (27, NULL,  N'Bone Artifact',  N'SUBCATEGORY', 3,  N'0.1.3',  N'Bone_Artifact');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (28, NULL,  N'Butchering',  N'SUBCATEGORY', 3,  N'0.1.3',  N'Butchering');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (29, NULL,  N'Spiral Fracture',  N'SUBCATEGORY', 3,  N'0.1.3',  N'Spiral_Fracture');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (30, NULL,  N'Burning',  N'SUBCATEGORY', 3,  N'0.1.3',  N'Burning');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (31, NULL,  N'Site',  N'SUBCATEGORY', 5,  N'4.5',  N'Site');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (32, NULL,  N'North',  N'SUBCATEGORY', 5,  N'4.5',  N'North');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (33, NULL,  N'East',  N'SUBCATEGORY', 5,  N'4.5',  N'East');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (34, NULL,  N'Unit',  N'SUBCATEGORY', 5,  N'4.5',  N'Unit');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (35, NULL,  N'Locus',  N'SUBCATEGORY', 5,  N'4.5',  N'Locus');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (36, NULL,  N'Slash',  N'SUBCATEGORY', 5,  N'4.5',  N'Slash');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (37, NULL,  N'Feature',  N'SUBCATEGORY', 5,  N'4.5',  N'Feature');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (38, NULL,  N'Level',  N'SUBCATEGORY', 6,  N'4.6',  N'Level');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (39, NULL,  N'Stratum',  N'SUBCATEGORY', 6,  N'4.6',  N'Stratum');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (40, NULL,  N'Depth',  N'SUBCATEGORY', 6,  N'4.6',  N'Depth');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (41, NULL,  N'Lot',  N'SUBCATEGORY', 4,  N'4',  N'Lot');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (42, NULL,  N'Date',  N'SUBCATEGORY', 4,  N'4',  N'Date');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (43, NULL,  N'Context',  N'SUBCATEGORY', 4,  N'4',  N'Context');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (44, NULL,  N'Feature Type',  N'SUBCATEGORY', 4,  N'4',  N'Feature_Type');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (45, NULL,  N'Screening',  N'SUBCATEGORY', 7,  N'4.7',  N'Screening');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (46, NULL,  N'Excavation Method',  N'SUBCATEGORY', 7,  N'4.7',  N'Excavation_Method');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (54, NULL,  N'Excavated Volumes',  N'SUBCATEGORY', 4,  N'4',  N'Excavated_Volumes');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (71, NULL,  N'Type',  N'SUBCATEGORY', 58,  N'58',  N'Type');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (72, NULL,  N'Form',  N'SUBCATEGORY', 58,  N'58',  N'Form');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (73, NULL,  N'Material',  N'SUBCATEGORY', 58,  N'58',  N'Material');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (74, NULL,  N'Count',  N'SUBCATEGORY', 58,  N'58',  N'Count');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (75, NULL,  N'Other',  N'SUBCATEGORY', 58,  N'58',  N'Other');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (81, NULL,  N'Taxon',  N'SUBCATEGORY', 59,  N'59',  N'Taxon');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (82, NULL,  N'Modification',  N'SUBCATEGORY', 59,  N'59',  N'Modification');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (83, NULL,  N'Measurement',  N'SUBCATEGORY', 59,  N'59',  N'Measurement');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (84, NULL,  N'Count',  N'SUBCATEGORY', 59,  N'59',  N'Count');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (85, NULL,  N'Weight',  N'SUBCATEGORY', 59,  N'59',  N'Weight');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (86, NULL,  N'Other',  N'SUBCATEGORY', 59,  N'59',  N'Other');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (91, NULL,  N'Code',  N'SUBCATEGORY', 60,  N'60',  N'Code');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (92, NULL,  N'Label',  N'SUBCATEGORY', 60,  N'60',  N'Label');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (93, NULL,  N'Description',  N'SUBCATEGORY', 60,  N'60',  N'Description');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (94, NULL,  N'Notes',  N'SUBCATEGORY', 60,  N'60',  N'Notes');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (95, NULL,  N'Other',  N'SUBCATEGORY', 60,  N'60',  N'Other');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (101, NULL,  N'Date',  N'SUBCATEGORY', 61,  N'61',  N'Date');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (102, NULL,  N'Error',  N'SUBCATEGORY', 61,  N'61',  N'Error');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (103, NULL,  N'Other',  N'SUBCATEGORY', 61,  N'61',  N'Other');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (111, NULL,  N'Ware',  N'SUBCATEGORY', 47,  N'47',  N'Ware');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (112, NULL,  N'Type',  N'SUBCATEGORY', 47,  N'47',  N'Type');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (113, NULL,  N'Form',  N'SUBCATEGORY', 47,  N'47',  N'Form');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (114, NULL,  N'Part',  N'SUBCATEGORY', 47,  N'47',  N'Part');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (115, NULL,  N'Design',  N'SUBCATEGORY', 47,  N'47',  N'Design');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (116, NULL,  N'Count',  N'SUBCATEGORY', 47,  N'47',  N'Count');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (117, NULL,  N'Weight',  N'SUBCATEGORY', 47,  N'47',  N'Weight');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (118, NULL,  N'Other',  N'SUBCATEGORY', 47,  N'47',  N'Other');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (121, NULL,  N'Material',  N'SUBCATEGORY', 48,  N'48',  N'Material');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (122, NULL,  N'Form',  N'SUBCATEGORY', 48,  N'48',  N'Form');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (123, NULL,  N'Count',  N'SUBCATEGORY', 48,  N'48',  N'Count');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (124, NULL,  N'Weight',  N'SUBCATEGORY', 48,  N'48',  N'Weight');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (125, NULL,  N'Measurement',  N'SUBCATEGORY', 48,  N'48',  N'Measurement');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (126, NULL,  N'Other',  N'SUBCATEGORY', 48,  N'48',  N'Other');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (131, NULL,  N'Material',  N'SUBCATEGORY', 49,  N'49',  N'Material');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (132, NULL,  N'Form',  N'SUBCATEGORY', 49,  N'49',  N'Form');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (133, NULL,  N'Count',  N'SUBCATEGORY', 49,  N'49',  N'Count');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (134, NULL,  N'Weight',  N'SUBCATEGORY', 49,  N'49',  N'Weight');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (135, NULL,  N'Measurement',  N'SUBCATEGORY', 49,  N'49',  N'Measurement');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (136, NULL,  N'Other',  N'SUBCATEGORY', 49,  N'49',  N'Other');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (141, NULL,  N'Type',  N'SUBCATEGORY', 55,  N'55',  N'Type');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (142, NULL,  N'Count',  N'SUBCATEGORY', 55,  N'55',  N'Count');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (143, NULL,  N'Weight',  N'SUBCATEGORY', 55,  N'55',  N'Weight');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (144, NULL,  N'Other',  N'SUBCATEGORY', 55,  N'55',  N'Other');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (151, NULL,  N'Taxon',  N'SUBCATEGORY', 56,  N'56',  N'Taxon');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (152, NULL,  N'Count',  N'SUBCATEGORY', 56,  N'56',  N'Count');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (153, NULL,  N'Other',  N'SUBCATEGORY', 56,  N'56',  N'Other');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (161, NULL,  N'Taxon',  N'SUBCATEGORY', 57,  N'57',  N'Taxon');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (162, NULL,  N'Count',  N'SUBCATEGORY', 57,  N'57',  N'Count');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (163, NULL,  N'Other',  N'SUBCATEGORY', 57,  N'57',  N'Other');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (171, NULL,  N'Cultural Modification',  N'SUBCATEGORY', 0,  N'0',  N'Cultural_Modification');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (172, NULL,  N'Excavated Volumes',  N'SUBCATEGORY', 0,  N'0',  N'Excavated_Volumes');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (173, NULL,  N'Horizontal Location',  N'SUBCATEGORY', 0,  N'0',  N'Horizontal_Location');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (174, NULL,  N'Modification',  N'SUBCATEGORY', 0,  N'0',  N'Modification');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (175, NULL,  N'Natural Modification',  N'SUBCATEGORY', 0,  N'0',  N'Natural_Modification');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (176, NULL,  N'Recovery Method',  N'SUBCATEGORY', 0,  N'0',  N'Recovery_Method');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (177, NULL,  N'Vertical Position',  N'SUBCATEGORY', 0,  N'0',  N'Vertical_Position');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (181, NULL,  N'Project',  N'SUBCATEGORY', 4,  N'4',  N'Project');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (182, NULL,  N'Sex',  N'SUBCATEGORY', 0,  N'0',  N'Sex');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (183, NULL,  N'Anterior Posterior',  N'SUBCATEGORY', 0,  N'0',  N'Anterior_Posterior');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (184, NULL,  N'Pathologies',  N'SUBCATEGORY', 0,  N'0',  N'Pathologies');
INSERT INTO category_variable (id, description, name, type, parent_id, encoded_parent_ids, label) VALUES (185, NULL,  N'Age',  N'SUBCATEGORY', 0,  N'0',  N'Age');
--------------------------- category_variable_synonyms ---------------------------
INSERT INTO category_variable_synonyms (categoryvariable_id, synonyms) VALUES (8,  N'Elements');
INSERT INTO category_variable_synonyms (categoryvariable_id, synonyms) VALUES (9,  N'Species');
INSERT INTO category_variable_synonyms (categoryvariable_id, synonyms) VALUES (10,  N'Symmetry');
INSERT INTO category_variable_synonyms (categoryvariable_id, synonyms) VALUES (17,  N'Quantity');
INSERT INTO category_variable_synonyms (categoryvariable_id, synonyms) VALUES (17,  N'Number');
INSERT INTO category_variable_synonyms (categoryvariable_id, synonyms) VALUES (21,  N'Amount Present');
INSERT INTO category_variable_synonyms (categoryvariable_id, synonyms) VALUES (22,  N'Fragmentation');
INSERT INTO category_variable_synonyms (categoryvariable_id, synonyms) VALUES (34,  N'Room');
INSERT INTO category_variable_synonyms (categoryvariable_id, synonyms) VALUES (34,  N'Operation');
INSERT INTO category_variable_synonyms (categoryvariable_id, synonyms) VALUES (36,  N'Slash No');
INSERT INTO category_variable_synonyms (categoryvariable_id, synonyms) VALUES (37,  N'Feature No');
INSERT INTO category_variable_synonyms (categoryvariable_id, synonyms) VALUES (37,  N'FN');
INSERT INTO category_variable_synonyms (categoryvariable_id, synonyms) VALUES (37,  N'Cluster');
INSERT INTO category_variable_synonyms (categoryvariable_id, synonyms) VALUES (41,  N'Lot No');
INSERT INTO category_variable_synonyms (categoryvariable_id, synonyms) VALUES (41,  N'Spec');
INSERT INTO category_variable_synonyms (categoryvariable_id, synonyms) VALUES (41,  N'Spec No');
INSERT INTO category_variable_synonyms (categoryvariable_id, synonyms) VALUES (41,  N'Log');
INSERT INTO category_variable_synonyms (categoryvariable_id, synonyms) VALUES (41,  N'Log No');
INSERT INTO category_variable_synonyms (categoryvariable_id, synonyms) VALUES (41,  N'Bag');
INSERT INTO category_variable_synonyms (categoryvariable_id, synonyms) VALUES (41,  N'Bag No');
INSERT INTO category_variable_synonyms (categoryvariable_id, synonyms) VALUES (41,  N'Case');
INSERT INTO category_variable_synonyms (categoryvariable_id, synonyms) VALUES (41,  N'Case No');
INSERT INTO category_variable_synonyms (categoryvariable_id, synonyms) VALUES (42,  N'Time');
INSERT INTO category_variable_synonyms (categoryvariable_id, synonyms) VALUES (42,  N'Age');
INSERT INTO category_variable_synonyms (categoryvariable_id, synonyms) VALUES (43,  N'Courtyard');
INSERT INTO category_variable_synonyms (categoryvariable_id, synonyms) VALUES (43,  N'Feat# Cat#');
INSERT INTO category_variable_synonyms (categoryvariable_id, synonyms) VALUES (46,  N'Recovery Method');
--------------------------- culture_keyword ---------------------------
...
--------------------------- creator ---------------------------
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (100, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (8007, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (8008, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (8009, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (8489,  '2010-08-05', NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (8424,  '2010-07-29', NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (8425,  '2010-07-29', NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (8426,  '2010-07-29', NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (8394,  '2010-07-22', NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (8621,  '2010-09-01', NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (1, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (6, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (38, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (60, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (121, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (5349, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (5979, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (8014, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (8018, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (8019, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (8044, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (8067, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (8161, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (8344,  '2010-06-08', NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (8389,  '2010-07-19', NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (8422,  '2010-07-29', NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (8608,  '2010-08-31', NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (11015, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (11017, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (11018, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (11019, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (11037, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (11044, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (11055, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (11110, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (11149, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (11150, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (11153, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (11154, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (11156, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (11157, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (11158, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (11159, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (11001, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (11003, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (11006, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (11008, NULL, NULL, NULL, NULL);
INSERT INTO creator (id, date_created, last_updated, location, url) VALUES (11009, NULL, NULL, NULL, NULL);
--------------------------- institution ---------------------------
...
--------------------------- resource ---------------------------
INSERT INTO resource (id, access_counter, confidential, date_registered, description, resource_type, title, submitter_id, url, updater_id, date_updated, status) VALUES (3074, 56,  false ,  '2010-03-05 12:59:58.505', NULL,  N'DATASET',  N'Durrington Walls Humerus Dataset', 6, NULL, 6,  '2010-03-05 12:59:58.505',  N'ACTIVE');
INSERT INTO resource (id, access_counter, confidential, date_registered, description, resource_type, title, submitter_id, url, updater_id, date_updated, status) VALUES (3462, 61,  false ,  '2010-07-09 12:57:10.251',  N'DELETED; Ooutdated ---Working ontologies used by the Archaeology Data Service/tDAR Transatlantic Archaeology Gateway initiative funded by NEH and JISC. These ontologies have to do with the project''s Work Package II that is directed to detailed cross search of faunal databases.',  N'PROJECT',  N'Fauna Ontologies - Transatlantic Archaeology Gateway - OUTDATED', 6, NULL, 8019,  '2011-03-05 17:35:21.101',  N'ACTIVE');
INSERT INTO resource (id, access_counter, confidential, date_registered, description, resource_type, title, submitter_id, url, updater_id, date_updated, status) VALUES (1628, 145,  false ,  '2009-11-11 09:35:05.465',  N'The Heshotauthla Archaeological Research Project (HARP) did limited excavation at the Pueblo IV site of Heshotauthla and intensive systematic survey in the area of the site on the Zuni Indian Reservation.  Excavation was limited to areas threatened by erosion and areas thought t have been previously excavated by the Hemenway Southwestern Archaeological Expedition in the late 1880s.  HARP survey recorded 305 prehistoric and historic sites in 10.4 square kilometers, including a post-Chaocan great house with a great kiva.',  N'PROJECT',  N'Heshotauthla Archaeological Research Project (HARP)', 6, NULL, 6,  '2009-11-11 09:35:05.465',  N'ACTIVE');
INSERT INTO resource (id, access_counter, confidential, date_registered, description, resource_type, title, submitter_id, url, updater_id, date_updated, status) VALUES (4287, 70,  true ,  '2010-09-02 13:05:13.595',  N'Inventory survey of Montezuma Castle National Monument was conducted
from April 11 to May 7, 1988. Of the 70 sites recorded, 30 were new
additions to the site inventory. Cliff dwellings, rockshelters and pueblos
were recorded along with one and two-room masonry structures, roasting pits and artifact scatters. Agricultural feature sites include the canals at
Montezuma Well. A site with prehistoric cobble concentrations, a burial
ground, a bedrock mortar site, a lithic scatter, a historical site and three
sites with enigmatic rock features complete the inventory. The development of architecture at the Monument is seen in the early pithouses (Squaw Peak and Camp Verde phases) excavated by Breternitz (1960), followed in time by surface structures, rockshelters with masonry rooms and finally the Honanki-Tuzigoot phase cliff dwellings.

In addition to the survey, the project included a detailed and
systematic re-recording of Montezuma Castle''s 20 rooms. The results of
this work, Part II of the report, are a roorn-by-roorn description,
chronological summary of previous research and stabilization, a record of
historic graffiti, and interpretation of construction sequence and room
function. No structural deterioration was recorded, but continued periodic
inspection by a trained specialist is recommended',  N'DOCUMENT',  N'Archeological Survey and Architectural Study of Montezuma Castle National Monument', 5349, NULL, 8344,  '2011-04-07 16:46:50.436',  N'ACTIVE');
INSERT INTO resource (id, access_counter, confidential, date_registered, description, resource_type, title, submitter_id, url, updater_id, date_updated, status) VALUES (262, 137,  false ,  '2009-05-26 21:38:53.091',  N'A survey and excavation project directed by Keith Kintigh and executed from 1983 through 1994.  Approximate 58km2 were surveyed and 560 sites were recorded.  Substantial excavations were undertaken at the Hinkson Site great house complex and Jaralosa Pueblo.  Test excavations were completed at H-Spear, a Chacoan Great House located by the project and Ojo Bonito Pueblo.  The project took place on the ranch of Mrs. Everett (Mabel) Hinkson (deceased).  Most of the project work was done as a part of an Arizona State University summer archaeological field school.  ',  N'PROJECT',  N'Ojo Bonito Archaeological Project (OBAP)', 6, NULL, 6,  '2010-10-18 12:25:01.026',  N'ACTIVE');
INSERT INTO resource (id, access_counter, confidential, date_registered, description, resource_type, title, submitter_id, url, updater_id, date_updated, status) VALUES (4231, 36,  false ,  '2010-08-14 11:55:20.911',  N'2008 New Philadelphia Archaeology Report, Chapter 3, Block 3, Lot 4',  N'DOCUMENT',  N'2008 New Philadelphia Archaeology Report, Chapter 3, Block 3, Lot 4', 8422, NULL, 8422,  '2010-08-14 11:55:20.911',  N'ACTIVE');
INSERT INTO resource (id, access_counter, confidential, date_registered, description, resource_type, title, submitter_id, url, updater_id, date_updated, status) VALUES (3794, 45,  false ,  '2010-07-22 14:03:57.722', NULL,  N'DOCUMENT',  N'Faunal Coding Key', 8161, NULL, 8161,  '2010-07-22 14:03:57.722',  N'ACTIVE');
INSERT INTO resource (id, access_counter, confidential, date_registered, description, resource_type, title, submitter_id, url, updater_id, date_updated, status) VALUES (3087, 40,  false ,  '2010-03-05 16:04:45.919', NULL,  N'CODING_SHEET',  N'Durrington Walls - Coding Sheet - Fauna -  Fusion  ', 6, NULL, 6,  '2010-03-05 16:04:45.919',  N'ACTIVE');
INSERT INTO resource (id, access_counter, confidential, date_registered, description, resource_type, title, submitter_id, url, updater_id, date_updated, status) VALUES (3088, 46,  false ,  '2010-03-05 16:05:35.9',  N'Knowth Stage 8 Fauna Dataset',  N'DATASET',  N'Knowth Stage 8 Fauna Dataset', 6, NULL, 8608,  '2010-11-19 08:50:30.811',  N'ACTIVE');
INSERT INTO resource (id, access_counter, confidential, date_registered, description, resource_type, title, submitter_id, url, updater_id, date_updated, status) VALUES (3167, 38,  false ,  '2010-03-05 16:06:13.44', NULL,  N'CODING_SHEET',  N'Knowth - Coding Sheet - Fauna - Fusion', 6, NULL, 6,  '2010-03-05 16:06:13.44',  N'ACTIVE');
INSERT INTO resource (id, access_counter, confidential, date_registered, description, resource_type, title, submitter_id, url, updater_id, date_updated, status) VALUES (139, 47,  false ,  '2008-04-24 00:37:53.078', NULL,  N'PROJECT',  N'Rudd Creek Archaeological Project', 38, NULL, 38,  '2008-04-24 00:37:53.078',  N'ACTIVE');
INSERT INTO resource (id, access_counter, confidential, date_registered, description, resource_type, title, submitter_id, url, updater_id, date_updated, status) VALUES (2420, 76,  false ,  '2009-09-16 07:41:11.726',  N'This NSF-funded research project was directed by Patty Jo Watson, Steven, LeBlanc, and Charles Redman.  In the summers of 1972 and 1973 it accomplished survey and excavation in the El Morro Valley of New Mexico.  ',  N'PROJECT',  N'Cibola Archaeological Research Project (CARP)', 6, NULL, 6,  '2009-09-16 07:41:11.726',  N'ACTIVE');
INSERT INTO resource (id, access_counter, confidential, date_registered, description, resource_type, title, submitter_id, url, updater_id, date_updated, status) VALUES (449, 29,  false ,  '2009-11-10 13:50:48.203', NULL,  N'CODING_SHEET',  N'CARP Fauna Proximal-Distal', 6, NULL, 6,  '2009-11-10 13:50:48.203',  N'ACTIVE');
INSERT INTO resource (id, access_counter, confidential, date_registered, description, resource_type, title, submitter_id, url, updater_id, date_updated, status) VALUES (1656, 41,  false ,  '2010-04-07 00:52:30.62', NULL,  N'CODING_SHEET',  N'HARP Fauna Species Coding Sheet', 6, NULL, 6,  '2010-04-07 00:52:30.62',  N'ACTIVE');
INSERT INTO resource (id, access_counter, confidential, date_registered, description, resource_type, title, submitter_id, url, updater_id, date_updated, status) VALUES (3073, 40,  false ,  '2010-03-05 12:52:53.862',  N'This is a project set up to include files for the April 2010 ADS/tDAR workshop at the University of York.',  N'PROJECT',  N'TAG Faunal Workshop', 6, NULL, 6,  '2010-03-05 12:52:53.862',  N'ACTIVE');
INSERT INTO resource (id, access_counter, confidential, date_registered, description, resource_type, title, submitter_id, url, updater_id, date_updated, status) VALUES (3479, 24,  false ,  '2010-07-09 15:35:06.14', NULL,  N'ONTOLOGY',  N'(Outdated) TAG Fauna Ontology - Taxon', 6, NULL, 6,  '2011-01-24 15:19:27.431',  N'ACTIVE');
INSERT INTO resource (id, access_counter, confidential, date_registered, description, resource_type, title, submitter_id, url, updater_id, date_updated, status) VALUES (3738, 66,  false ,  '2010-07-22 13:40:50.11',  N'These databases are from on-going archaeological research in the city of Alexandria, Virginia on eighteenth and nineteenth century occupations, directed by Dr. Pamela Cressey, City Archaeologist.',  N'PROJECT',  N'Alexandria, Virginia Historic Period Fauna', 8161, NULL, 8019,  '2011-04-13 17:22:13.514',  N'ACTIVE');
INSERT INTO resource (id, access_counter, confidential, date_registered, description, resource_type, title, submitter_id, url, updater_id, date_updated, status) VALUES (3805, 137,  false ,  '2010-07-29 13:23:45.594',  N'Archaeological and historical analysis of New Philadelphia, Illinois, founded in 1836.',  N'PROJECT',  N'New Philadelphia Archaeology Project', 8422, NULL, 8422,  '2010-07-29 13:23:45.594',  N'ACTIVE');
INSERT INTO resource (id, access_counter, confidential, date_registered, description, resource_type, title, submitter_id, url, updater_id, date_updated, status) VALUES (4232, 22,  false ,  '2010-08-14 11:57:13.085',  N'2008 New Philadelphia Archaeology Report, Chapter 4, Block 7, Lot 1',  N'DOCUMENT',  N'2008 New Philadelphia Archaeology Report, Chapter 4, Block 7, Lot 1', 8422, NULL, 8422,  '2010-08-14 11:57:13.085',  N'ACTIVE');
INSERT INTO resource (id, access_counter, confidential, date_registered, description, resource_type, title, submitter_id, url, updater_id, date_updated, status) VALUES (4230, 35,  false ,  '2010-08-14 11:54:03.684',  N'2008 New Philadelphia Archaeology Report, Chapter 2, An Investigation of New Philadelphia Using Thermal Infrared Remote Sensing',  N'DOCUMENT',  N'2008 New Philadelphia Archaeology Report, Chapter 2, An Investigation of New Philadelphia Using Thermal Infrared Remote Sensing', 8422, NULL, 8422,  '2010-08-14 11:54:03.684',  N'ACTIVE');
INSERT INTO resource (id, access_counter, confidential, date_registered, description, resource_type, title, submitter_id, url, updater_id, date_updated, status) VALUES (4279, 72,  false ,  '2010-09-02 10:04:31.402',  N'WACC reports of archaeological excavation and survey projects within and near Tuzigoot National Monument, Yavapai County, Arizona.',  N'PROJECT',  N'The Archaeology of Tuzigoot National Monument and Montezuma Castle National Monument', 5349, NULL, 5349,  '2010-09-02 10:04:31.402',  N'ACTIVE');
--------------------------- full_user ---------------------------
INSERT INTO full_user (id, person_id, resource_id) VALUES (7474, 5979, 262);
INSERT INTO full_user (id, person_id, resource_id) VALUES (8009, 5979, 1628);
INSERT INTO full_user (id, person_id, resource_id) VALUES (8011, 5979, 2420);
INSERT INTO full_user (id, person_id, resource_id) VALUES (8012, 60, 2420);
INSERT INTO full_user (id, person_id, resource_id) VALUES (8443, 8018, 1656);
INSERT INTO full_user (id, person_id, resource_id) VALUES (8444, 8019, 1656);
INSERT INTO full_user (id, person_id, resource_id) VALUES (8489, 8018, 449);
INSERT INTO full_user (id, person_id, resource_id) VALUES (8490, 8019, 449);
INSERT INTO full_user (id, person_id, resource_id) VALUES (8791, 1, 3088);
INSERT INTO full_user (id, person_id, resource_id) VALUES (8792, 8019, 3088);
INSERT INTO full_user (id, person_id, resource_id) VALUES (8793, 8018, 3088);
INSERT INTO full_user (id, person_id, resource_id) VALUES (9043, 60, 1628);
INSERT INTO full_user (id, person_id, resource_id) VALUES (9149, 5979, 449);
INSERT INTO full_user (id, person_id, resource_id) VALUES (9150, 8161, 449);
INSERT INTO full_user (id, person_id, resource_id) VALUES (9176, 8161, 2420);
INSERT INTO full_user (id, person_id, resource_id) VALUES (9177, 8018, 2420);
INSERT INTO full_user (id, person_id, resource_id) VALUES (9178, 8019, 2420);
INSERT INTO full_user (id, person_id, resource_id) VALUES (9179, 8161, 1628);
INSERT INTO full_user (id, person_id, resource_id) VALUES (9180, 8019, 1628);
INSERT INTO full_user (id, person_id, resource_id) VALUES (9181, 8018, 1628);
INSERT INTO full_user (id, person_id, resource_id) VALUES (9183, 8018, 262);
INSERT INTO full_user (id, person_id, resource_id) VALUES (9184, 8161, 262);
INSERT INTO full_user (id, person_id, resource_id) VALUES (9186, 60, 262);
INSERT INTO full_user (id, person_id, resource_id) VALUES (9187, 8019, 262);
INSERT INTO full_user (id, person_id, resource_id) VALUES (9227, 8014, 3479);
INSERT INTO full_user (id, person_id, resource_id) VALUES (9228, 8161, 3479);
INSERT INTO full_user (id, person_id, resource_id) VALUES (9420, 8389, 1628);
INSERT INTO full_user (id, person_id, resource_id) VALUES (9436, 8044, 3805);
INSERT INTO full_user (id, person_id, resource_id) VALUES (9437, 8344, 3805);
INSERT INTO full_user (id, person_id, resource_id) VALUES (9567, 8344, 4287);
INSERT INTO full_user (id, person_id, resource_id) VALUES (9568, 8018, 4287);
INSERT INTO full_user (id, person_id, resource_id) VALUES (9569, 8044, 4287);
INSERT INTO full_user (id, person_id, resource_id) VALUES (10790, 8019, 3738);
--------------------------- read_user ---------------------------
INSERT INTO read_user (id, resource_id, person_id) VALUES (28, 3738, 5979);
INSERT INTO read_user (id, resource_id, person_id) VALUES (29, 3738, 6);
INSERT INTO read_user (id, resource_id, person_id) VALUES (30, 3738, 8019);
INSERT INTO read_user (id, resource_id, person_id) VALUES (31, 3738, 1);
INSERT INTO read_user (id, resource_id, person_id) VALUES (32, 3738, 8014);
--------------------------- project ---------------------------
...
INSERT INTO information_resource (id, available_to_public, date_created, date_made_public, project_id, provider_institution_id, last_uploaded, external_reference, resource_language, metadata_language, copy_location, inheriting_investigation_information, inheriting_site_information, inheriting_material_information, inheriting_other_information, inheriting_cultural_information, inheriting_spatial_information, inheriting_temporal_information) VALUES (4230,  true ,  N'2008',  '2010-08-14 11:54:03.691', 3805, NULL, NULL,  false ,  N'ENGLISH', NULL, NULL,  false ,  false ,  false ,  false ,  false ,  false ,  false );
INSERT INTO information_resource (id, available_to_public, date_created, date_made_public, project_id, provider_institution_id, last_uploaded, external_reference, resource_language, metadata_language, copy_location, inheriting_investigation_information, inheriting_site_information, inheriting_material_information, inheriting_other_information, inheriting_cultural_information, inheriting_spatial_information, inheriting_temporal_information) VALUES (4231,  true ,  N'2008',  '2010-08-14 11:55:20.918', 3805, NULL, NULL,  false ,  N'ENGLISH', NULL, NULL,  false ,  false ,  false ,  false ,  false ,  false ,  false );
INSERT INTO information_resource (id, available_to_public, date_created, date_made_public, project_id, provider_institution_id, last_uploaded, external_reference, resource_language, metadata_language, copy_location, inheriting_investigation_information, inheriting_site_information, inheriting_material_information, inheriting_other_information, inheriting_cultural_information, inheriting_spatial_information, inheriting_temporal_information) VALUES (4232,  true ,  N'2008',  '2010-08-14 11:57:13.092', 3805, NULL, NULL,  false ,  N'ENGLISH', NULL, NULL,  false ,  false ,  false ,  false ,  false ,  false ,  false );
INSERT INTO information_resource (id, available_to_public, date_created, date_made_public, project_id, provider_institution_id, last_uploaded, external_reference, resource_language, metadata_language, copy_location, inheriting_investigation_information, inheriting_site_information, inheriting_material_information, inheriting_other_information, inheriting_cultural_information, inheriting_spatial_information, inheriting_temporal_information) VALUES (3074,  true ,  N'2010',  '2010-03-05 12:59:59.441', 3073, 11015, NULL,  false ,  N'ENGLISH', NULL, NULL,  false ,  false ,  false ,  false ,  false ,  false ,  false );
INSERT INTO information_resource (id, available_to_public, date_created, date_made_public, project_id, provider_institution_id, last_uploaded, external_reference, resource_language, metadata_language, copy_location, inheriting_investigation_information, inheriting_site_information, inheriting_material_information, inheriting_other_information, inheriting_cultural_information, inheriting_spatial_information, inheriting_temporal_information) VALUES (3087,  true ,  N'2010',  '2010-03-05 13:14:42.52', 3073, NULL, NULL,  false , NULL, NULL, NULL,  false ,  false ,  false ,  false ,  false ,  false ,  false );
INSERT INTO information_resource (id, available_to_public, date_created, date_made_public, project_id, provider_institution_id, last_uploaded, external_reference, resource_language, metadata_language, copy_location, inheriting_investigation_information, inheriting_site_information, inheriting_material_information, inheriting_other_information, inheriting_cultural_information, inheriting_spatial_information, inheriting_temporal_information) VALUES (3088,  true ,  N'2010',  '2010-11-19 08:50:30.826', 3073, 11015, NULL,  false ,  N'ENGLISH', NULL, NULL,  false ,  false ,  false ,  false ,  false ,  false ,  false );
INSERT INTO information_resource (id, available_to_public, date_created, date_made_public, project_id, provider_institution_id, last_uploaded, external_reference, resource_language, metadata_language, copy_location, inheriting_investigation_information, inheriting_site_information, inheriting_material_information, inheriting_other_information, inheriting_cultural_information, inheriting_spatial_information, inheriting_temporal_information) VALUES (449,  true ,  N'2009',  '2009-11-10 13:50:48.207', 2420, NULL, NULL,  false , NULL, NULL, NULL,  false ,  false ,  false ,  false ,  false ,  false ,  false );
INSERT INTO information_resource (id, available_to_public, date_created, date_made_public, project_id, provider_institution_id, last_uploaded, external_reference, resource_language, metadata_language, copy_location, inheriting_investigation_information, inheriting_site_information, inheriting_material_information, inheriting_other_information, inheriting_cultural_information, inheriting_spatial_information, inheriting_temporal_information) VALUES (3794,  false ,  N'2010',  '2015-07-22 14:03:57.731', 3738, 11154, NULL,  false ,  N'ENGLISH', NULL, NULL,  false ,  false ,  false ,  false ,  false ,  false ,  false );
INSERT INTO information_resource (id, available_to_public, date_created, date_made_public, project_id, provider_institution_id, last_uploaded, external_reference, resource_language, metadata_language, copy_location, inheriting_investigation_information, inheriting_site_information, inheriting_material_information, inheriting_other_information, inheriting_cultural_information, inheriting_spatial_information, inheriting_temporal_information) VALUES (3479,  true , NULL,  '2011-01-24 15:19:27.441', 3462, NULL, NULL,  false , NULL, NULL, NULL,  false ,  false ,  false ,  false ,  false ,  false ,  false );
INSERT INTO information_resource (id, available_to_public, date_created, date_made_public, project_id, provider_institution_id, last_uploaded, external_reference, resource_language, metadata_language, copy_location, inheriting_investigation_information, inheriting_site_information, inheriting_material_information, inheriting_other_information, inheriting_cultural_information, inheriting_spatial_information, inheriting_temporal_information) VALUES (4287,  true ,  N'1988',  '2011-04-07 16:46:53.467', 4279, 11055, NULL,  false ,  N'ENGLISH', NULL,  N'Montezuma Castle National Monument, Western Archeological and Conservation Center',  false ,  false ,  false ,  false ,  false ,  false ,  false );
...
INSERT INTO information_resource_file (id, download_count, general_type, latest_version, sequence_number, information_resource_id, confidential, status) VALUES (730, 15,  N'DOCUMENT', 0, 0, 4287,  true , NULL);
...
--------------------------- image ---------------------------
--------------------------- coding_sheet ---------------------------
INSERT INTO coding_sheet (id, category_variable_id) VALUES (3087, 14);
INSERT INTO coding_sheet (id, category_variable_id) VALUES (3167, 14);
INSERT INTO coding_sheet (id, category_variable_id) VALUES (449, 12);
INSERT INTO coding_sheet (id, category_variable_id) VALUES (1656, 9);
--------------------------- ontology ---------------------------
INSERT INTO ontology (id, category_variable_id) VALUES (3479, 9);
--------------------------- dataset ---------------------------
...
--------------------------- data_table_column ---------------------------
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3091,  N'VARCHAR',  N'REC ID', 36, NULL, 3089, NULL, NULL,  N'REC ID', NULL,  N'NUMERIC');
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3097,  N'VARCHAR',  N'PROX', 12, NULL, 3089, NULL, NULL,  N'PROX', NULL,  N'TEXT');
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3094,  N'VARCHAR',  N'Species', 9, NULL, 3089, NULL, NULL,  N'Species', NULL,  N'TEXT');
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3102,  N'VARCHAR',  N'Gnawed', 24, NULL, 3089, NULL, NULL,  N'Gnawed', NULL,  N'TEXT');
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3158,  N'VARCHAR',  N'M2WA', NULL, NULL, 3089, NULL, NULL,  N'M2WA', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3159,  N'VARCHAR',  N'M2WP', NULL, NULL, 3089, NULL, NULL,  N'M2WP', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3150,  N'VARCHAR',  N'P3', NULL, NULL, 3089, NULL, NULL,  N'P3', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3147,  N'VARCHAR',  N'P', NULL, NULL, 3089, NULL, NULL,  N'P', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3157,  N'VARCHAR',  N'M2', NULL, NULL, 3089, NULL, NULL,  N'M2', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3163,  N'VARCHAR',  N'M3L', NULL, NULL, 3089, NULL, NULL,  N'M3L', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3160,  N'VARCHAR',  N'M2L', NULL, NULL, 3089, NULL, NULL,  N'M2L', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3117,  N'VARCHAR',  N'BFdl', NULL, NULL, 3089, NULL, NULL,  N'BFdl', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3164,  N'VARCHAR',  N'M3Wa', NULL, NULL, 3089, NULL, NULL,  N'M3Wa', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3076,  N'VARCHAR',  N'AREA', 35, NULL, 3075, NULL, NULL,  N'AREA', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3080,  N'VARCHAR',  N'BD', NULL, NULL, 3075, NULL, NULL,  N'BD', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3077,  N'VARCHAR',  N'BOX', 41, NULL, 3075, NULL, NULL,  N'BOX', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3081,  N'VARCHAR',  N'BT', NULL, NULL, 3075, NULL, NULL,  N'BT', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3086,  N'VARCHAR',  N'COMMENTS', NULL, NULL, 3075, NULL, NULL,  N'COMMENTS', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3082,  N'VARCHAR',  N'HTC', 0, NULL, 3075, NULL, NULL,  N'HTC', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3078,  N'VARCHAR',  N'N', 17, NULL, 3075, NULL, NULL,  N'N', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3083,  N'VARCHAR',  N'SD', 0, NULL, 3075, NULL, NULL,  N'SD', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3079,  N'VARCHAR',  N'SIDE', 10, NULL, 3075, NULL, NULL,  N'SIDE', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3124,  N'VARCHAR',  N'B@F', NULL, NULL, 3089, NULL, NULL,  N'B@F', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3116,  N'VARCHAR',  N'BFdm', NULL, NULL, 3089, NULL, NULL,  N'BFdm', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3110,  N'VARCHAR',  N'Bp', NULL, NULL, 3089, NULL, NULL,  N'Bp', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3125,  N'VARCHAR',  N'CAc', NULL, NULL, 3089, NULL, NULL,  N'CAc', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3119,  N'VARCHAR',  N'Ddl', NULL, NULL, 3089, NULL, NULL,  N'Ddl', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3120,  N'VARCHAR',  N'DtL', NULL, NULL, 3089, NULL, NULL,  N'DtL', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3112,  N'VARCHAR',  N'Bd', NULL, NULL, 3089, NULL, NULL,  N'Bd', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3131,  N'VARCHAR',  N'C', NULL, NULL, 3089, NULL, NULL,  N'C', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3098,  N'VARCHAR',  N'DIST', NULL, NULL, 3089, NULL, NULL,  N'DIST', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3122,  N'VARCHAR',  N'Dm', NULL, NULL, 3089, NULL, NULL,  N'Dm', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3113,  N'VARCHAR',  N'GB', NULL, NULL, 3089, NULL, NULL,  N'GB', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3108,  N'VARCHAR',  N'GLC', NULL, NULL, 3089, NULL, NULL,  N'GLC', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3137,  N'VARCHAR',  N'I', NULL, NULL, 3089, NULL, NULL,  N'I', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3140,  N'VARCHAR',  N'I3', NULL, NULL, 3089, NULL, NULL,  N'I3', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3104,  N'VARCHAR',  N'Measurable', NULL, NULL, 3089, NULL, NULL,  N'Measurable', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3148,  N'VARCHAR',  N'P1', NULL, NULL, 3089, NULL, NULL,  N'P1', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3111,  N'VARCHAR',  N'SD', NULL, NULL, 3089, NULL, NULL,  N'SD', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3090,  N'VARCHAR',  N'STAGE', 39, NULL, 3089, NULL, NULL,  N'STAGE', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3134,  N'VARCHAR',  N'di1', NULL, NULL, 3089, NULL, NULL,  N'di1', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3141,  N'VARCHAR',  N'dp', NULL, NULL, 3089, NULL, NULL,  N'dp', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3144,  N'VARCHAR',  N'dp4', NULL, NULL, 3089, NULL, NULL,  N'dp4', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3165,  N'VARCHAR',  N'M3Wc', NULL, NULL, 3089, NULL, NULL,  N'M3Wc', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3107,  N'VARCHAR',  N'GLl', NULL, NULL, 3089, NULL, NULL,  N'GLl', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3123,  N'VARCHAR',  N'BFd', NULL, NULL, 3089, NULL, NULL,  N'BFd', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3114,  N'VARCHAR',  N'BT', NULL, NULL, 3089, NULL, NULL,  N'BT', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3103,  N'VARCHAR',  N'Butchery', NULL, NULL, 3089, NULL, NULL,  N'Butchery', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3126,  N'VARCHAR',  N'CAc+d', NULL, NULL, 3089, NULL, NULL,  N'CAc+d', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3118,  N'VARCHAR',  N'Ddm', NULL, NULL, 3089, NULL, NULL,  N'Ddm', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3121,  N'VARCHAR',  N'DtM', NULL, NULL, 3089, NULL, NULL,  N'DtM', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3106,  N'VARCHAR',  N'GL', NULL, NULL, 3089, NULL, NULL,  N'GL', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3115,  N'VARCHAR',  N'HTC', NULL, NULL, 3089, NULL, NULL,  N'HTC', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3139,  N'VARCHAR',  N'I2', NULL, NULL, 3089, NULL, NULL,  N'I2', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3152,  N'VARCHAR',  N'M', NULL, NULL, 3089, NULL, NULL,  N'M', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3153,  N'VARCHAR',  N'M1', NULL, NULL, 3089, NULL, NULL,  N'M1', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3161,  N'VARCHAR',  N'M12', NULL, NULL, 3089, NULL, NULL,  N'M12', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3156,  N'VARCHAR',  N'M1L', NULL, NULL, 3089, NULL, NULL,  N'M1L', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3154,  N'VARCHAR',  N'M1WA', NULL, NULL, 3089, NULL, NULL,  N'M1WA', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3155,  N'VARCHAR',  N'M1WP', NULL, NULL, 3089, NULL, NULL,  N'M1WP', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3162,  N'VARCHAR',  N'M3', NULL, NULL, 3089, NULL, NULL,  N'M3', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3151,  N'VARCHAR',  N'P4', NULL, NULL, 3089, NULL, NULL,  N'P4', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3166,  N'VARCHAR',  N'PM', NULL, NULL, 3089, NULL, NULL,  N'PM', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3128,  N'VARCHAR',  N'SLC', NULL, NULL, 3089, NULL, NULL,  N'SLC', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3093,  N'VARCHAR',  N'FEATURE INFO', 4, NULL, 3089, NULL, NULL,  N'FEATURE INFO', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3109,  N'VARCHAR',  N'GH', NULL, NULL, 3089, NULL, NULL,  N'GH', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3127,  N'VARCHAR',  N'GLP', NULL, NULL, 3089, NULL, NULL,  N'GLP', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3095,  N'VARCHAR',  N'Element', 8, NULL, 3089, NULL, NULL,  N'Element', NULL,  N'NUMERIC');
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3092,  N'VARCHAR',  N'FEATURE', 37, NULL, 3089, NULL, NULL,  N'FEATURE', NULL,  N'TEXT');
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3129,  N'VARCHAR',  N'Wmin', NULL, NULL, 3089, NULL, NULL,  N'Wmin', NULL,  N'MEASUREMENT');
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3138,  N'VARCHAR',  N'I1', NULL, NULL, 3089, NULL, NULL,  N'I1', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3099,  N'VARCHAR',  N'Other', NULL, NULL, 3089, NULL, NULL,  N'Other', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3149,  N'VARCHAR',  N'P2', NULL, NULL, 3089, NULL, NULL,  N'P2', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3096,  N'VARCHAR',  N'SIDE', NULL, NULL, 3089, NULL, NULL,  N'SIDE', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3105,  N'VARCHAR',  N'Toothwear', NULL, NULL, 3089, NULL, NULL,  N'Toothwear', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3132,  N'VARCHAR',  N'dc', NULL, NULL, 3089, NULL, NULL,  N'dc', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3135,  N'VARCHAR',  N'di2', NULL, NULL, 3089, NULL, NULL,  N'di2', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3142,  N'VARCHAR',  N'dp2', NULL, NULL, 3089, NULL, NULL,  N'dp2', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3145,  N'VARCHAR',  N'dp4L', NULL, NULL, 3089, NULL, NULL,  N'dp4L', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3133,  N'VARCHAR',  N'di', NULL, NULL, 3089, NULL, NULL,  N'di', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3136,  N'VARCHAR',  N'di3', NULL, NULL, 3089, NULL, NULL,  N'di3', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3143,  N'VARCHAR',  N'dp3', NULL, NULL, 3089, NULL, NULL,  N'dp3', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3146,  N'VARCHAR',  N'dp4W', NULL, NULL, 3089, NULL, NULL,  N'dp4W', NULL, NULL);
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3130,  N'VARCHAR',  N'Wmax', NULL, NULL, 3089, NULL, NULL,  N'Wmax', NULL,  N'MEASUREMENT');
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3085,  N'VARCHAR',  N'FUSD', 14, NULL, 3075, 3087, NULL,  N'FUSD', NULL,  N'CODED_VALUE');
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3100,  N'VARCHAR',  N'FUSP', 14, NULL, 3089, 3167, NULL,  N'FUSP', NULL,  N'CODED_VALUE');
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3101,  N'VARCHAR',  N'FUSD', 14, NULL, 3089, 3167, NULL,  N'FUSD', NULL,  N'CODED_VALUE');
INSERT INTO data_table_column (id, column_data_type, name, category_variable_id, default_ontology_id, data_table_id, default_coding_sheet_id, description, display_name, measurement_unit, column_encoding_type) VALUES (3084,  N'VARCHAR',  N'FUSP', 14, NULL, 3075, 3087, NULL,  N'FUSP', NULL,  N'CODED_VALUE');
--------------------------- document ---------------------------
...
INSERT INTO latitude_longitude (id, maximum_latitude, maximum_longitude, minimum_latitude, minimum_longitude, resource_id) VALUES (6207, 34.65693354309436, -111.7477798461914, 34.60325873668768, -111.8521499633789, 4287);
...
--------------------------- resource_creator ---------------------------
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (214,  N'AUTHOR', 0, 8489, 4287);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (215,  N'AUTHOR', 1, 8621, 4287);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1485,  N'SPONSOR', NULL, 11157, 3805);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1486,  N'COLLABORATOR', NULL, 11159, 3805);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1487,  N'COLLABORATOR', NULL, 11110, 3805);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1488,  N'COLLABORATOR', NULL, 11158, 3805);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1743,  N'PROJECT_DIRECTOR', NULL, 8426, 3805);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1744,  N'PROJECT_DIRECTOR', NULL, 8425, 3805);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1745,  N'PRINCIPAL_INVESTIGATOR', NULL, 8422, 3805);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1746,  N'PROJECT_DIRECTOR', NULL, 8424, 3805);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1327,  N'SPONSOR', NULL, 11001, 262);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1328,  N'LANDOWNER', NULL, 11149, 262);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1329,  N'SPONSOR', NULL, 11003, 262);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1565,  N'PROJECT_DIRECTOR', NULL, 6, 262);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1566,  N'PRINCIPAL_INVESTIGATOR', NULL, 6, 262);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1459,  N'LANDOWNER', NULL, 11009, 1628);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1460,  N'SPONSOR', NULL, 11003, 1628);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1461,  N'PERMITTER', NULL, 11009, 1628);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1462,  N'REPOSITORY', NULL, 11003, 1628);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1732,  N'PRINCIPAL_INVESTIGATOR', NULL, 6, 1628);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1917,  N'CONTACT', NULL, 8394, 3794);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1542,  N'REPOSITORY', NULL, 11003, 2420);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1544,  N'SPONSOR', NULL, 11008, 2420);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1711,  N'PRINCIPAL_INVESTIGATOR', NULL, 8009, 2420);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1712,  N'PRINCIPAL_INVESTIGATOR', NULL, 8007, 2420);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1713,  N'PRINCIPAL_INVESTIGATOR', NULL, 8008, 2420);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1543,  N'PREPARER', NULL, 11037, 2420);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1518,  N'SPONSOR', NULL, 11153, 3738);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1345,  N'SPONSOR', NULL, 11006, 139);
INSERT INTO resource_creator (id, role, sequence_number, creator_id, resource_id) VALUES (1658,  N'CREATOR', NULL, 100, 139);
--------------------------- resource_annotation ---------------------------
...
SELECT setval('full_user_id_seq', (SELECT MAX(id) FROM full_user)+1);
...
SELECT setval('read_user_id_seq', (SELECT MAX(id) FROM read_user)+1);
