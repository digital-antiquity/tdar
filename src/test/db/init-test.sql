...
--------------------------- culture_keyword ---------------------------
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (3, NULL,  N'Pre-Clovis',  true ,  N'1',  true , NULL,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (4, NULL,  N'PaleoIndian',  true ,  N'2',  true , NULL,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (8, NULL,  N'Archaic',  true ,  N'3',  true , NULL,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (12, NULL,  N'Hopewell',  true ,  N'4',  true , NULL,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (13, NULL,  N'Woodland',  true ,  N'5',  true , NULL,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (17, NULL,  N'Plains Village',  true ,  N'6',  true , NULL,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (18, NULL,  N'Mississippian',  true ,  N'7',  true , NULL,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (19, NULL,  N'Ancestral Puebloan',  true ,  N'8',  true , NULL,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (21, NULL,  N'Hohokam',  true ,  N'9',  true , NULL,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (23, NULL,  N'Patayan',  true ,  N'11',  true , NULL,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (24, NULL,  N'Fremont',  true ,  N'12',  true , NULL,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (25, NULL,  N'Historic',  true ,  N'13',  true , NULL,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (34, NULL,  N'Mogollon',  true ,  N'10',  true , NULL,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (26, NULL,  N'African American',  true ,  N'13.1',  true , 25,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (27, NULL,  N'Chinese American',  true ,  N'13.2',  true , 25,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (28, NULL,  N'Euroamerican',  true ,  N'13.3',  true , 25,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (29, NULL,  N'Japanese American',  true ,  N'13.4',  true , 25,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (30, NULL,  N'Native American',  true ,  N'13.5',  true , 25,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (31, NULL,  N'Spanish',  true ,  N'13.6',  true , 25,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (14, NULL,  N'Early Woodland',  true ,  N'5.1',  true , 13,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (15, NULL,  N'Middle Woodland',  true ,  N'5.2',  true , 13,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (16, NULL,  N'Late Woodland',  true ,  N'5.3',  true , 13,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (9, NULL,  N'Early Archaic',  true ,  N'3.1',  true , 8,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (10, NULL,  N'Middle Archaic',  true ,  N'3.2',  true , 8,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (11, NULL,  N'Late Archaic',  true ,  N'3.3',  true , 8,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (5, NULL,  N'Clovis',  true ,  N'2.1',  true , 4,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (6, NULL,  N'Folsom',  true ,  N'2.2',  true , 4,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (7, NULL,  N'Dalton',  true ,  N'2.3',  true , 4,  N'ACTIVE', NULL, 0);
--------------------------- site_type_keyword ---------------------------
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (251,  N'The locations and/or archaeological remains of a building or buildings used for human habitation. Use more specific term(s) if possible.',  N'Domestic Structure or Architectural Complex',  true ,  N'1',  true , NULL,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (252,  N'Locations, or the remains of multiple structures or features, that were inhabited by humans in the past. Use more specific term(s) if possible.',  N'Settlements',  true ,  N'1.1',  true , 251,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (253,  N'A relatively small, short-term human habitation occupied by a relatively small group.',  N'Encampment',  true ,  N'1.1.1',  true , 252,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (254,  N'Relatively small, self-contained groups of dwellings and associated structures providing shelter and a home base for its human inhabitants.  Typically occupied for a number of years or decades, and in some cased for centuries.',  N'Hamlet / village',  true ,  N'1.1.2',  true , 252,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (255,  N'Larger settlements with more dwellings and a wide variety of other kinds of structures.  These settlements typically have internally organized infrastructure of streets or walkways and water and waste-disposal systems. Typically occupied for decades or centuries.',  N'Town / city',  true ,  N'1.1.3',  true , 252,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (256,  N'Locations, or the remains of buildings that were inhabited by humans in the past. Use more specific term(s) if possible.',  N'Domestic Structures',  true ,  N'1.2',  true , 251,  N'ACTIVE', NULL, 0);
...
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (266,  N'All temporary shelters (e.g. lean-tos, windbreaks, brush enclosures, sun shades etc.).',  N'Shade structure / ramada',  true ,  N'1.2.10',  true , 256,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (267,  N'Circular pattern (sometimes outlined with rocks) left when a tipi or tent is dismantled.',  N'Tent ring / tipi ring',  true ,  N'1.2.11',  true , 256,  N'ACTIVE', NULL, 0);
...
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (269,  N'A low mounded area of shell built to provide a platform for one or more domestic structures.',  N'Shell mound',  true ,  N'1.2.13',  true , 256,  N'ACTIVE', NULL, 0);
...
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (260,  N'A slightly raised, mounded area of earth or rock built to provide a platform for a single domestic structure.',  N'House mound',  true ,  N'1.2.4',  true , 256,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (261,  N'The remains of a small surface structure constructed of brush (wattle) and mud (daub).',  N'Wattle & daub (jacal) structure',  true ,  N'1.2.5',  true , 256,  N'ACTIVE', NULL, 0);
...
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (272,  N'The locations and/or archaeological remains of features or sites related to resource extraction, commerce, industry, or transportation. Use more specific term(s) if possible.',  N'Resource Extraction/Production/Transportation Structure or Features',  true ,  N'2',  true , NULL,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (273,  N'Locations, or the remains of features or facilities, that were used for  horticulture, agriculture, or animal husbandry. Use more specific term(s) if possible.',  N'Agricultural or Herding',  true ,  N'2.1',  true , 272,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (274,  N'An area of land, often enclosed, used for cultivation. Fields are not necessarily formally bounded, and may be identifiable based on diagnostic features such as boundary markers or raised beds.',  N'Agricultural field or field feature',  true ,  N'2.1.1',  true , 273,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (275,  N'Ditch or interrelated group of ditches, acequias, head gates, and drains that constitute an irrigation system for individual watering and irrigation features.',  N'Canal or canal feature',  true ,  N'2.1.2',  true , 273,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (276,  N'An enclosure for confining livestock. May be constructed of any material and incorporate natural features or vegetation as part of the enclosure.',  N'Corral',  true ,  N'2.1.3',  true , 273,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (277,  N'Natural or artificial lake in which water can be stored for future use.',  N'Reservoir',  true ,  N'2.1.4',  true , 273,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (278,  N'An artificially created, more or less level area cut into the side of a hill. The edge may be bordered by stone or other material to prevent erosion.',  N'Terrace',  true ,  N'2.1.5',  true , 273,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (279,  N'A device which controls the flow of water, particularly run-off. Includes check dams, flumes, gabions, head gates, drop structures, and riprap.',  N'Water control feature',  true ,  N'2.1.6',  true , 273,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (280,  N'Locations, or the remains of features or facilities, that were used for commercial or industrial purposes. Use more specific term(s) if possible.',  N'Commercial or Industrial Structures',  true ,  N'2.2',  true , 272,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (281,  N'A relative large structure in which goods were manufactured or prepared for commercial distribution.',  N'Factory / workshop',  true ,  N'2.2.1',  true , 280,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (282,  N'A relatively small facility (one or a few rooms) for processing grain, wood, or other materials.',  N'Mill',  true ,  N'2.2.2',  true , 280,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (283,  N'A mill for processing grain, typically powered by water or wind.',  N'Grist mill',  true ,  N'2.2.2.1',  true , 282,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (284,  N'A mill for processing timber or wood.',  N'Saw mill',  true ,  N'2.2.2.2',  true , 282,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (285,  N'A structure designed for catching fish. Sometimes constructed as a fence or enclosure of wooden stakes or stones, placed in a river, lake, wetland or tidal estuary.',  N'Fish trap / weir',  true ,  N'2.3',  true , 272,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (286,  N'Locations, or the remains of features or facilities, that were used for hunting or trapping animals. Use more specific term(s) if possible.',  N'Hunting / Trapping',  true ,  N'2.4',  true , 272,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (287,  N'Concentration of faunal remains resulting from human hunting activity.',  N'Butchering / kill site',  true ,  N'2.4.1',  true , 286,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (288,  N'Small, unroofed structure expediently constructed out of natural rock and/or wood as camouflage.',  N'Hunting blind',  true ,  N'2.4.2',  true , 286,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (289,  N'A cliff or other natural drop off where large game can be stampeded over the edge.',  N'Large game jump',  true ,  N'2.4.3',  true , 286,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (290,  N'Locations used for the extraction of metals, ores, minerals, or other materials.',  N'Mine',  true ,  N'2.5',  true , 272,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (291,  N'An excavation made in the earth for the purpose of digging out metallic ores, coal, salt, precious stones or other resources. Includes portals, adits, vent shafts, prospects, and haulage tunnels.',  N'Mine tunnels',  true ,  N'2.5.1',  true , 290,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (292,  N'The remains of facilities or equipment, usually above ground, used for processing or storing mined materials.',  N'Mine-related structures',  true ,  N'2.5.2',  true , 290,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (293,  N'Outcrops of lithic material that have been mined or otherwise utilized to obtain lithic raw materials.',  N'Quarry',  true ,  N'2.6',  true , 272,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (294,  N'The archaeological remains of identifiable paths or routes between two or more locations. Use more specific term(s) if possible.',  N'Road, Trail, and Related Structures or Features',  true ,  N'2.7',  true , 272,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (295,  N'A structure with one or more intervals under it to span a river or other space.',  N'Bridge',  true ,  N'2.7.1',  true , 294,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (296,  N'A road or pathway constructed from packed earth, stone, or shell, usually across a wetland or small water body.',  N'Causeway',  true ,  N'2.7.2',  true , 294,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (297,  N'Identifiable, linear archaeological remains of unknown function.',  N'Linear feature',  true ,  N'2.7.3',  true , 294,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (298,  N'Segment(s) of railroad tracks or railroad bed.',  N'Railroad',  true ,  N'2.7.4',  true , 294,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (299,  N'A prepared, formal way used for the passage of humans, animals, and/or vehicles. These include examples such as Chacoan roads.',  N'Road',  true ,  N'2.7.5',  true , 294,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (300,  N'An informal foot path used for the passage of humans, animals, and/or vehicles, defined and worn by use without formal construction or maintenance.',  N'Trail',  true ,  N'2.7.6',  true , 294,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (301,  N'The archaeological features or locations used for human burial or funerary activities. Use more specific term(s) if possible.',  N'Funerary and Burial Structures or Features',  true ,  N'3',  true , NULL,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (302,  N'A formal location for burying the dead.',  N'Cemetery',  true ,  N'3.1',  true , 301,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (303,  N'An artificial mound constructed using earth, shell, or stone for the purpose of holding one or more burials. Frequently containing several episodes of construction and burials from different periods of time.',  N'Burial mound',  true ,  N'3.2',  true , 301,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (304,  N'A structure in which recently deceased human bodies were placed so that the flesh and other soft tissue would decompose prior to final interment of the remains.',  N'Charnel house',  true ,  N'3.3',  true , 301,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (305,  N'A location containing a human burial, spatially removed from other archaeological evidence.',  N'Isolated burial',  true ,  N'3.4',  true , 301,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (306,  N'A secondary burial of multiple individuals.',  N'Ossuary',  true ,  N'3.5',  true , 301,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (307,  N'An unmarked human interment in a subterranean pit.',  N'Burial pit',  true ,  N'3.6',  true , 301,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (308,  N'A prepared, architecturally distinctive structure, normally sub-surface, often containing multiple interments.  Use for features such as shaft tombs.',  N'Tomb',  true ,  N'3.7',  true , 301,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (309,  N'The locations and/or archaeological remains of a building or buildings used for purposes other than human habitation. Use more specific term(s) if possible.',  N'Non-Domestic Structures',  true ,  N'4',  true , NULL,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (310,  N'An unroofed structure associated with the playing of the Mesoamerican ball game, found in the American southwest and parts of Mesoamerica.',  N'Ball Court',  true ,  N'4.1',  true , 309,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (330,  N'An enclosure, constructed of timbers or posts driven into ground, or otherwise walled.',  N'Palisade',  true ,  N'4.10',  true , 309,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (331,  N'An area which may be partially or completely enclosed by structural remains (standing or collapsed), used for community activities.  May contain temporary structures (e.g. sun shades or ramadas) as well as special activity areas (e.g. milling bins, hearths).',  N'Plaza',  true ,  N'4.11',  true , 309,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (332,  N'A massive structure, typically with triangular outer surfaces that converge at the top. Often flat-topped to accommodate public gatherings and/or buildings.',  N'Pyramid',  true ,  N'4.12',  true , 309,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (333,  N'A series of steps allowing access to a different level. Use for toe/hand holds, stairs, ladders, etc.',  N'Stairway',  true ,  N'4.13',  true , 309,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (334,  N'Architectural remnant of a building of unknown form or function.',  N'Structure',  true ,  N'4.14',  true , 309,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (335,  N'Architectural remnant of a prehistoric building of unknown form or function. Use more specific term if possible.',  N'Ancient structure',  true ,  N'4.14.1',  true , 310,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (336,  N'Architectural remnant of a historic building of unknown form or function. Use more specific term if possible.',  N'Historic structure',  true ,  N'4.14.2',  true , 310,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (337,  N'Small enclosure or hut used for steam baths, usually ephemeral in construction. Often with fire-cracked rock and/or hearths in association.',  N'Sweat house / sweat lodge',  true ,  N'4.15',  true , 309,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (338,  N'Monumental architecture constructed from stone or other materials, and used for religious and/or political purposes.',  N'Temple',  true ,  N'4.16',  true , 309,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (311,  N'Buildings, or the archaeological remains of features or facilities, that were used for religious purposes. Use more specific term(s) if possible.',  N'Church / religious structure',  true ,  N'4.2',  true , 309,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (312,  N'Remains of a prehistoric building or location designed for public religious services.',  N'Ancient church / religious structure',  true ,  N'4.2.1',  true , 311,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (313,  N'Remains of a historic building or location designed for public religious services.',  N'Historic church / religious structure',  true ,  N'4.2.2',  true , 311,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (314,  N'Locations, or the remains of buildings that were associated with communal or public activities.',  N'Communal / public structure',  true ,  N'4.3',  true , 309,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (315,  N'Specified area containing evidence that is associated with prehistoric communal or public activity.',  N'Ancient communal / public structure',  true ,  N'4.3.1',  true , 314,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (316,  N'Specified area containing evidence that is associated with historic communal or public activity.',  N'Historic communal / public structure',  true ,  N'4.3.2',  true , 314,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (317,  N'A multi-story building with massive masonry or adobe walls, found in the Chacoan and Hohokam regions of the American southwest.',  N'Great House / Big House',  true ,  N'4.4',  true , 309,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (318,  N'Locations, or the remains of buildings that were associated with governmental activities.',  N'Governmental structure',  true ,  N'4.5',  true , 309,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (319,  N'Specified area containing evidence that is associated with prehistoric governmental activity.',  N'Ancient governmental structure',  true ,  N'4.5.1',  true , 318,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (320,  N'Specified area containing evidence that is associated with historic governmental activity.',  N'Historic governmental structure',  true ,  N'4.5.2',  true , 318,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (321,  N'Circular or rectangular ceremonial structure. May be subterranean or part of a surface room block.',  N'Kiva / Great Kiva',  true ,  N'4.6',  true , 309,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (322,  N'Military-related structure constructed for various purposes (personnel barracks, testing, aircraft storage or landing, etc.).',  N'Military structure',  true ,  N'4.7',  true , 309,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (323,  N'An above ground construction of earth, shell or other material, undifferentiated as to function.',  N'Mound / Earthwork',  true ,  N'4.8',  true , 309,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (324,  N'An above ground prepared surface on which a non-residential structure is built.',  N'Building substructure',  true ,  N'4.8.1',  true , 323,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (325,  N'A non-residential cultural construction made from earth, shell or other materials, often formed to enclose or demarcate an area, or, in the case of causeways, to link areas. Examples include shell rings.',  N'Ancient earthwork',  true ,  N'4.8.2',  true , 323,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (326,  N'A defensive construction made from earth, shell or other materials.',  N'Military earthwork',  true ,  N'4.8.3',  true , 323,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (327,  N'An above ground construction of earth, shell or other material, built in the shape of geometric, animal or other symbolic forms. Prominent examples include Effigy Mounds National Monument and Serpent Mound.',  N'Geometric / effigy / zoomorphic mound',  true ,  N'4.8.4',  true , 323,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (328,  N'A large, circular area defined by a perimeter of mounded shell (often several meters in height), for example, Archaic Period shell ring sites in the American southeast.',  N'Shell ring',  true ,  N'4.8.5',  true , 323,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (329,  N'A large and/or ornate building, normally associated with a high ranking family or individual.',  N'Palace',  true ,  N'4.9',  true , 309,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (339,  N'A localized area containing evidence of human activity. Use more specific term(s) if possible.',  N'Archaeological Feature',  true ,  N'5',  true , NULL,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (340,  N'Prehistoric lithic and/or ceramic scatters with no features.',  N'Artifact Scatter',  true ,  N'5.1',  true , 339,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (355,  N'A discrete excavation directly attributable to human activity. Use more specific term(s) if possible.',  N'Pit',  true ,  N'5.10',  true , 339,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (356,  N'A discrete excavation directly attributable to human activity that was used for the disposal of discarded artifacts, ecofacts and other cultural materials.',  N'Refuse pit',  true ,  N'5.10.1',  true , 340,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (357,  N'An enclosed space used to heat objects placed within its bounds. Includes earth ovens, oven pits, mud ovens, and bread ovens.',  N'Roasting pit / oven / horno',  true ,  N'5.10.2',  true , 340,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (358,  N'A discrete excavation directly attributable to human activity used for storing artifacts, ecofacts and other cultural materials.',  N'Storage pit',  true ,  N'5.10.3',  true , 340,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (359,  N'One or more upright posts, remains of posts, or sockets usually associated with a larger feature or structure such as a building, fence, corral, stockade, pen, etc.',  N'Post hole / post mold',  true ,  N'5.11',  true , 339,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (360,  N'Group of rocks which appear to have some cultural association. Use for possible walls, wall-like phenomena, human produced architectural oddities, rock piles, etc.',  N'Rock alignment',  true ,  N'5.12',  true , 339,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (341,  N'Mound or stack of rocks used to mark significant locations (e.g., boundaries or claims).',  N'Cairn',  true ,  N'5.2',  true , 339,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (342,  N'A structure that creates a boundary, barrier, or enclosure. Construction materials can vary widely and may include unmodified natural materials (such as brush).',  N'Fence',  true ,  N'5.3',  true , 339,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (343,  N'Discolored area of soil, often including charcoal, ash deposits or fire cracked rock, exhibiting evidence of use in association with fire.  May be bounded (e.g., rock ring) or ill-defined.',  N'Hearth',  true ,  N'5.4',  true , 339,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (344,  N'A find spot containing a single artifact.',  N'Isolated artifact',  true ,  N'5.5',  true , 339,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (345,  N'A find spot containing a single cultural feature.',  N'Isolated feature',  true ,  N'5.6',  true , 339,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (346,  N'Oven used to bake food, fire pottery, or thermally alter other materials (e.g., bricks, lithic materials).',  N'Kiln',  true ,  N'5.7',  true , 339,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (347,  N'An archaeological refuse deposit containing the broken or discarded remains of human activities. Use more specific term(s) if possible.',  N'Midden',  true ,  N'5.8',  true , 339,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (348,  N'A large, dense concentrations, often mounded, of fire cracked rock (FCR), usually associated with large scale plant processing. Although other cultural materials may be present in the midden, FCR is usually predominant.',  N'Burned rock midden',  true ,  N'5.8.1',  true , 347,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (349,  N'A surficial archaeological deposit containing discarded artifacts and other cultural materials. Midden deposits normally contain ashy or charcoal-stained sediments, and domestic-related items such as sherds, lithic debitage, and bone.',  N'Sheet midden',  true ,  N'5.8.2',  true , 347,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (350,  N'An archaeological deposit composed primarily of discarded mollusk shells.',  N'Shell midden',  true ,  N'5.8.3',  true , 347,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (351,  N'A substantial concentration of refuse, built up as a result of multiple episodes of deposition.',  N'Trash midden',  true ,  N'5.8.4',  true , 347,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (352,  N'A facility made or used for grinding or processing plant materials. Use more specific term(s) if possible.',  N'Milling feature',  true ,  N'5.9',  true , 339,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (353,  N'A pecked or ground concavity in a large boulder or outcrop, including both bedrock mortar and bedrock metate.',  N'Bedrock grinding feature',  true ,  N'5.9.1',  true , 352,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (354,  N'An enclosed container used for milling plant material. May be above ground or partially or completely underground.',  N'Milling Bin',  true ,  N'5.9.2',  true , 352,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (361,  N'Designs, whether carved, scraped, pecked or painted, applied to free-standing stones, cave walls, or the earth’s surface. Use more specific term(s) if possible.',  N'Rock Art',  true ,  N'6',  true , NULL,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (362,  N'Designs created on the ground surface by arranging rocks or other materials, or by scraping or altering the earth surface. Usually on a large scale.',  N'Intaglio / geoglyph',  true ,  N'6.1',  true , 361,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (363,  N'Design scratched, pecked, or scraped into a rock surface.',  N'Petroglyph',  true ,  N'6.2',  true , 361,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (364,  N'Design drawn in pigment upon an unprepared or ground rock surface.',  N'Pictograph',  true ,  N'6.3',  true , 361,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (365,  N'The locations and/or archaeological remains of ships, boats, or other vessels, or the facilities related to shipping or sailing.',  N'Water-related',  true ,  N'7',  true , NULL,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (366,  N'The remains of facilities or equipment related to boats, ships, or shipping. Use for dock, wharf etc.',  N'Shipping-related structure',  true ,  N'7.1',  true , 365,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (367,  N'The remains of a ship, boat or other vessel.',  N'Shipwreck',  true ,  N'7.2',  true , 365,  N'ACTIVE', NULL, 0);
INSERT INTO site_type_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (368,  N'The underwater remains of an aircraft.',  N'Submerged aircraft',  true ,  N'7.3',  true , 365,  N'ACTIVE', NULL, 0);
--------------------------- investigation_type ---------------------------
INSERT INTO investigation_type (id, definition, label, status, merge_keyword_id, occurrence) VALUES (1,  N'A study that involves the synthesis of the archaeological history of investigation and culture history of a location or area.',  N'Archaeological Overview',  N'ACTIVE', NULL, 0);
INSERT INTO investigation_type (id, definition, label, status, merge_keyword_id, occurrence) VALUES (3,  N'A study that involves research and analysis of archaeological resources held in a museum, historical society or other repository.',  N'Collections Research',  N'ACTIVE', NULL, 0);
INSERT INTO investigation_type (id, definition, label, status, merge_keyword_id, occurrence) VALUES (4,  N'An activity that involves discussions and meetings with communities, stakeholders, and other interested parties for the purpose of describing proposed archaeological activities and eliciting their comments, perspectives and feedback.',  N'Consultation',  N'ACTIVE', NULL, 0);
INSERT INTO investigation_type (id, definition, label, status, merge_keyword_id, occurrence) VALUES (7,  N'An activity employed to gather a general impression of the nature and distribution of archaeological or cultural resources in an area. Relatively little field work is conducted in relation to the size of the research area.',  N'Reconnaissance / Survey',  N'ACTIVE', NULL, 0);
INSERT INTO investigation_type (id, definition, label, status, merge_keyword_id, occurrence) VALUES (9,  N'Activities undertaken to plan and schedule future archaeological research.',  N'Research Design / Data Recovery Plan',  N'ACTIVE', NULL, 0);
INSERT INTO investigation_type (id, definition, label, status, merge_keyword_id, occurrence) VALUES (11,  N'An activity that involves the rehabilitation of eroding, slumping, subsiding or otherwise deteriorating archaeological resources, including structures and building materials.',  N'Site Stabilization',  N'ACTIVE', NULL, 0);
INSERT INTO investigation_type (id, definition, label, status, merge_keyword_id, occurrence) VALUES (8,  N'An activity involving the review of records, files, and other information about the sites recorded in a particular area.  Typically, such studies involve checking the site files and other archives in an agency''s database, or SHPO''s office, or State Archaeologist''s office.',  N'Records Search / Inventory Checking',  N'ACTIVE', NULL, 0);
INSERT INTO investigation_type (id, definition, label, status, merge_keyword_id, occurrence) VALUES (6,  N'A non-field study of archaeological theory, method or technique. These investigations may also include broadly synthetic regional studies.',  N'Methodology, Theory, or Synthesis',  N'ACTIVE', NULL, 0);
INSERT INTO investigation_type (id, definition, label, status, merge_keyword_id, occurrence) VALUES (13,  N'These are studies that examine aspects of the present or past natural environment to provide a context, often off-site,  for interpreting archaeological resources.  Sometimes reported in stand-alone volumes representing significant research, such investigations may include geomorphological, paleontological, or palynological work.',  N'Environment Research',  N'ACTIVE', NULL, 0);
INSERT INTO investigation_type (id, definition, label, status, merge_keyword_id, occurrence) VALUES (14,  N'This is research that focuses on the systematic description and analysis of cultural systems or lifeways.  These studies of contemporary people and cultures rely heavily on participant observation as well as interviews, oral histories, and review of relevant documents.  Ethnoarchaeological studies are a subset of this kind of research that investigate correlations between traditional contemporary cultures and patterns in the archaeological record.    ',  N'Ethnographic Research',  N'ACTIVE', NULL, 0);
INSERT INTO investigation_type (id, definition, label, status, merge_keyword_id, occurrence) VALUES (15,  N'These are studies of biological aspects of human individuals, groups, or cultural systems, including a broad range of topics describing and analyzing human physiology, osteology, diet, disease, and origins research. ',  N'Bioarchaeological Research',  N'ACTIVE', NULL, 0);
INSERT INTO investigation_type (id, definition, label, status, merge_keyword_id, occurrence) VALUES (16,  N'Descriptive and analytical research that documents, describes, and/or interprets detailed data on historic structures in an area, including images and floor plans. ',  N'Architectural Documentation',  N'ACTIVE', NULL, 0);
INSERT INTO investigation_type (id, definition, label, status, merge_keyword_id, occurrence) VALUES (17,  N'This kind of research includes systematic description and analysis of changes in cultural systems through time, using historical documents and oral and traditional histories.  Ethnohistoric studies typically deal with time periods of initial or early contact between different cultural systems, for example, European explorers or early colonists and indigenous cultures. ',  N'Ethnohistoric Research',  N'ACTIVE', NULL, 0);
INSERT INTO investigation_type (id, definition, label, status, merge_keyword_id, occurrence) VALUES (18,  N'These are investigations of the past using written records and other documents.  Evidence from the records are compared, judged for veracity, placed in chronological or topical sequence, and interpreted in light of preceding, contemporary, and subsequent events.',  N'Historic Background Research',  N'ACTIVE', NULL, 0);
INSERT INTO investigation_type (id, definition, label, status, merge_keyword_id, occurrence) VALUES (19,  N'Visits to a site to record archaeological resources and their conditions and recover finds that may have come to light since a previous visit.  Also refers to regular or systematic monitoring and recording of the condition of a site, checking for signs of vandalism, other human intervention, and natural processes that may have damaged the resource.',  N'Site Stewardship Monitoring',  N'ACTIVE', NULL, 0);
INSERT INTO investigation_type (id, definition, label, status, merge_keyword_id, occurrence) VALUES (20,  N'Observations and investigations conducted during any ground disturbing operation carried out for non-archaeological reasons (e.g. construction, land-leveling, wild land fire-fighting, etc.) that may reveal and/or damage archaeological deposits.',  N'Ground Disturbance Monitoring',  N'ACTIVE', NULL, 0);
INSERT INTO investigation_type (id, definition, label, status, merge_keyword_id, occurrence) VALUES (12,  N'This is an investigation employed to systematically gather data on the general presence or absence of archaeological resources, to define resource types, or to estimate the distribution of resources in an area. These studies may provide a general understanding of the resources in an area. This includes the description, analysis, and specialized studies of artifacts and samples recovered during survey. ',  N'Systematic Survey',  N'ACTIVE', NULL, 0);
INSERT INTO investigation_type (id, definition, label, status, merge_keyword_id, occurrence) VALUES (10,  N'These investigations include fieldwork undertaken to identify the archaeological resources in a given area and to collect information sufficient to evaluate the resource(s) and develop treatment recommendations. Such investigations typically determine the number, location, distribution and condition of archaeological resources. This includes the description, analysis, and specialized studies of artifacts and samples recovered during site testing. ',  N'Site Evaluation / Testing',  N'ACTIVE', NULL, 0);
INSERT INTO investigation_type (id, definition, label, status, merge_keyword_id, occurrence) VALUES (5,  N'These investigations include substantial field investigation of an archaeological site (or sites) involving the removal, and systematic recording of, archaeological matrix. These activities often mitigate the adverse effects of a public undertaking. This includes the description, analysis, and specialized studies of artifacts and samples recovered during excavations.',  N'Data Recovery / Excavation',  N'ACTIVE', NULL, 0);
INSERT INTO investigation_type (id, definition, label, status, merge_keyword_id, occurrence) VALUES (2,  N'These investigations include field and/or document and records reviews to gather data on the presence and type of historic structures and provide a general understanding of architectural and cultural resources in an area. ',  N'Architectural Survey',  N'ACTIVE', NULL, 0);
--------------------------- material_keyword ---------------------------
INSERT INTO material_keyword (id, definition, label, status, merge_keyword_id, occurrence) VALUES (1,  N'Historic or prehistoric artifacts made from pottery or fired clay',  N'Ceramic',  N'ACTIVE', NULL, 0);
INSERT INTO material_keyword (id, definition, label, status, merge_keyword_id, occurrence) VALUES (2,  N'Lithic artifacts such as tools, flakes, shatter, or debitage',  N'Chipped Stone',  N'ACTIVE', NULL, 0);
INSERT INTO material_keyword (id, definition, label, status, merge_keyword_id, occurrence) VALUES (3,  N'Material collected for use with dating techniques such as radiocarbon, dendrochronology or archaeomagnetism',  N'Dating Sample',  N'ACTIVE', NULL, 0);
INSERT INTO material_keyword (id, definition, label, status, merge_keyword_id, occurrence) VALUES (4,  N'Animal bone remains',  N'Fauna',  N'ACTIVE', NULL, 0);
INSERT INTO material_keyword (id, definition, label, status, merge_keyword_id, occurrence) VALUES (5,  N'Rocks showing evidence of intense heating or burning, carbon staining, or other indications of changes due to heat.',  N'Fire Cracked Rock',  N'ACTIVE', NULL, 0);
INSERT INTO material_keyword (id, definition, label, status, merge_keyword_id, occurrence) VALUES (6,  N'Historic or prehistoric artifacts made from glass',  N'Glass',  N'ACTIVE', NULL, 0);
INSERT INTO material_keyword (id, definition, label, status, merge_keyword_id, occurrence) VALUES (7,  N'Lithic artifact formed or finished by polishing the body or edges with an abrasive',  N'Ground Stone',  N'ACTIVE', NULL, 0);
INSERT INTO material_keyword (id, definition, label, status, merge_keyword_id, occurrence) VALUES (8,  N'Materials used for construction (e.g., brick, wood, adobe)',  N'Building Materials',  N'ACTIVE', NULL, 0);
INSERT INTO material_keyword (id, definition, label, status, merge_keyword_id, occurrence) VALUES (9,  N'The remains of any part of a human',  N'Human Remains',  N'ACTIVE', NULL, 0);
INSERT INTO material_keyword (id, definition, label, status, merge_keyword_id, occurrence) VALUES (10,  N'Plant remains such as fruit, seeds, buds, or other plant parts.',  N'Macrobotanical',  N'ACTIVE', NULL, 0);
INSERT INTO material_keyword (id, definition, label, status, merge_keyword_id, occurrence) VALUES (11,  N'Any prehistoric or historic artifact made of metal (e.g., iron, copper, gold, silver, etc.)',  N'Metal',  N'ACTIVE', NULL, 0);
INSERT INTO material_keyword (id, definition, label, status, merge_keyword_id, occurrence) VALUES (12,  N'Natural inorganic substance possessing a definite chemical composition in a crystalline form.',  N'Mineral',  N'ACTIVE', NULL, 0);
INSERT INTO material_keyword (id, definition, label, status, merge_keyword_id, occurrence) VALUES (13,  N'Use for any microscopic plant remains',  N'Pollen',  N'ACTIVE', NULL, 0);
INSERT INTO material_keyword (id, definition, label, status, merge_keyword_id, occurrence) VALUES (14,  N'Modified or unmodified objects made from mollusc shell.',  N'Shell',  N'ACTIVE', NULL, 0);
INSERT INTO material_keyword (id, definition, label, status, merge_keyword_id, occurrence) VALUES (15,  N'Modified or unmodified objects made from the roots, trunk, or branches of trees or shrubs.',  N'Wood',  N'ACTIVE', NULL, 0);
--------------------------- creator ---------------------------
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (11914,  '2011-03-11',  '2011-03-11 00:00:00', NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (8489,  '2010-08-05',  '2010-08-05 00:00:00', NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12082,  '2011-04-28',  '2011-04-28 00:00:00', NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (8424,  '2010-07-29',  '2010-07-29 00:00:00', NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (8425,  '2010-07-29',  '2010-07-29 00:00:00', NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (8426,  '2010-07-29',  '2010-07-29 00:00:00', NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12129,  '2011-05-07',  '2011-05-07 00:00:00', NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (8394,  '2010-07-22',  '2010-07-22 00:00:00', NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12214,  '2011-05-12',  '2011-05-12 00:00:00', NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (8621,  '2010-09-01',  '2010-09-01 00:00:00', NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (8344,  '2010-06-08',  '2010-06-08 00:00:00', NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (8389,  '2010-07-19',  '2010-07-19 00:00:00', NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (8422,  '2010-07-29',  '2010-07-29 00:00:00', NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (8608,  '2010-08-31',  '2010-08-31 00:00:00', NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12396,  '2011-06-25',  '2011-06-25 00:00:00', NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12395,  '2011-06-25',  '2011-06-25 00:00:00', NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12397,  '2011-06-25',  '2011-06-25 00:00:00', NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (11785,  '2011-02-10',  '2011-02-10 00:00:00', NULL, NULL,  N'ACTIVE', 0);
...
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12474,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12475,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12476,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12477,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12478,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12479,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12480,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12481,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12482,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12483,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12484,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12485,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12486,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12487,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12488,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12489,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12490,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12491,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12492,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12493,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12494,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12495,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12496,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12497,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12498,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12499,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12500,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12501,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12502,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12503,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12504,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12505,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12506,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12507,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12508,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12509,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12510,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12511,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12512,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12513,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12514,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12515,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12516,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12517,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12518,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12519,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12520,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12521,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12522,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12523,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12524,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12525,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12526,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12527,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12528,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12529,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12530,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12531,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12532,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12533,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12534,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12535,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12536,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12537,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12538,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12539,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12540,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12541,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12542,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
INSERT INTO creator (id, date_created, last_updated, url, description, status, occurrence) VALUES (12543,  '2012-08-03', NULL, NULL, NULL,  N'ACTIVE', 0);
--------------------------- institution ---------------------------
...
--------------------------- person ---------------------------
INSERT INTO person (id, contributor, email, first_name, last_name, registered, rpa_number, phone, contributor_reason, institution_id, total_login, last_login, penultimate_login, phone_public, email_public, username, merge_creator_id, proxyinstitution_id, proxy_note, tos_version, contributor_agreement_version) VALUES (8608,  true ,  N'james.t.devos@asu.edu',  N'jim',  N'DeVos',  true , NULL,  N'480-965-6533',  N'n/a', 11003, 18,  '2013-09-10 16:52:21.754',  '2013-09-10 14:35:58.302',  false ,  false ,  N'james.t.devos@asu.edu', NULL, NULL, NULL, 0, 0);
INSERT INTO person (id, contributor, email, first_name, last_name, registered, rpa_number, phone, contributor_reason, institution_id, total_login, last_login, penultimate_login, phone_public, email_public, username, merge_creator_id, proxyinstitution_id, proxy_note, tos_version, contributor_agreement_version) VALUES (8489,  false , NULL,  N'Susan J.',  N'Wells',  false , NULL, NULL, NULL, NULL, 0, NULL, NULL,  false ,  false , NULL, NULL, NULL, NULL, 0, 0);
INSERT INTO person (id, contributor, email, first_name, last_name, registered, rpa_number, phone, contributor_reason, institution_id, total_login, last_login, penultimate_login, phone_public, email_public, username, merge_creator_id, proxyinstitution_id, proxy_note, tos_version, contributor_agreement_version) VALUES (8424,  false ,  N'pshackel@anth.umd.edu',  N'Paul',  N'Shackel',  false , NULL, NULL, NULL, NULL, 0, NULL, NULL,  false ,  false , NULL, NULL, NULL, NULL, 0, 0);
INSERT INTO person (id, contributor, email, first_name, last_name, registered, rpa_number, phone, contributor_reason, institution_id, total_login, last_login, penultimate_login, phone_public, email_public, username, merge_creator_id, proxyinstitution_id, proxy_note, tos_version, contributor_agreement_version) VALUES (8425,  false ,  N'martin@museum.state.il.us',  N'Terrance',  N'Martin',  false , NULL, NULL, NULL, NULL, 0, NULL, NULL,  false ,  false , NULL, NULL, NULL, NULL, 0, 0);
INSERT INTO person (id, contributor, email, first_name, last_name, registered, rpa_number, phone, contributor_reason, institution_id, total_login, last_login, penultimate_login, phone_public, email_public, username, merge_creator_id, proxyinstitution_id, proxy_note, tos_version, contributor_agreement_version) VALUES (8426,  false ,  N'agbe-davies@unc.edu',  N'Anna',  N'Agbe-Davies',  false , NULL, NULL, NULL, NULL, 0, NULL, NULL,  false ,  false , NULL, NULL, NULL, NULL, 0, 0);
INSERT INTO person (id, contributor, email, first_name, last_name, registered, rpa_number, phone, contributor_reason, institution_id, total_login, last_login, penultimate_login, phone_public, email_public, username, merge_creator_id, proxyinstitution_id, proxy_note, tos_version, contributor_agreement_version) VALUES (8394,  false , NULL,  N'Pamela',  N'Cressey',  false , NULL, NULL, NULL, NULL, 0, NULL, NULL,  false ,  false , NULL, NULL, NULL, NULL, 0, 0);
INSERT INTO person (id, contributor, email, first_name, last_name, registered, rpa_number, phone, contributor_reason, institution_id, total_login, last_login, penultimate_login, phone_public, email_public, username, merge_creator_id, proxyinstitution_id, proxy_note, tos_version, contributor_agreement_version) VALUES (8621,  false , NULL,  N'Keith M.',  N'Anderson',  false , NULL, NULL, NULL, NULL, 0, NULL, NULL,  false ,  false , NULL, NULL, NULL, NULL, 0, 0);
INSERT INTO person (id, contributor, email, first_name, last_name, registered, rpa_number, phone, contributor_reason, institution_id, total_login, last_login, penultimate_login, phone_public, email_public, username, merge_creator_id, proxyinstitution_id, proxy_note, tos_version, contributor_agreement_version) VALUES (100,  false ,  N'tiffany.clark@asu.edu',  N'Tiffany',  N'Clark',  false , NULL, NULL, NULL, NULL, 0, NULL, NULL,  false ,  false , NULL, NULL, NULL, NULL, 0, 0);
INSERT INTO person (id, contributor, email, first_name, last_name, registered, rpa_number, phone, contributor_reason, institution_id, total_login, last_login, penultimate_login, phone_public, email_public, username, merge_creator_id, proxyinstitution_id, proxy_note, tos_version, contributor_agreement_version) VALUES (8009,  false , NULL,  N'Steven',  N'LeBlanc',  false , NULL, NULL, NULL, NULL, 0, NULL, NULL,  false ,  false , NULL, NULL, NULL, NULL, 0, 0);
INSERT INTO person (id, contributor, email, first_name, last_name, registered, rpa_number, phone, contributor_reason, institution_id, total_login, last_login, penultimate_login, phone_public, email_public, username, merge_creator_id, proxyinstitution_id, proxy_note, tos_version, contributor_agreement_version) VALUES (5979,  true ,  N'karen.schollmeyer@asu.edu',  N'Karen',  N'Schollmeyer',  true , NULL, NULL, NULL, 11018, 0, NULL, NULL,  false ,  false ,  N'karen.schollmeyer@asu.edu', NULL, NULL, NULL, 0, 0);
INSERT INTO person (id, contributor, email, first_name, last_name, registered, rpa_number, phone, contributor_reason, institution_id, total_login, last_login, penultimate_login, phone_public, email_public, username, merge_creator_id, proxyinstitution_id, proxy_note, tos_version, contributor_agreement_version) VALUES (1,  true ,  N'allen.lee@asu.edu',  N'Allen',  N'Lee',  true , NULL, NULL, NULL, 11006, 0, NULL, NULL,  false ,  false ,  N'allen.lee@asu.edu', NULL, NULL, NULL, 0, 0);
INSERT INTO person (id, contributor, email, first_name, last_name, registered, rpa_number, phone, contributor_reason, institution_id, total_login, last_login, penultimate_login, phone_public, email_public, username, merge_creator_id, proxyinstitution_id, proxy_note, tos_version, contributor_agreement_version) VALUES (6,  true ,  N'kintigh@asu.edu',  N'Keith',  N'Kintigh',  true , NULL, NULL, NULL, 11003, 0, NULL, NULL,  false ,  false ,  N'kintigh@asu.edu', NULL, NULL, NULL, 0, 0);
INSERT INTO person (id, contributor, email, first_name, last_name, registered, rpa_number, phone, contributor_reason, institution_id, total_login, last_login, penultimate_login, phone_public, email_public, username, merge_creator_id, proxyinstitution_id, proxy_note, tos_version, contributor_agreement_version) VALUES (38,  true ,  N'mallorie.hatch@asu.edu',  N'Mallorie',  N'Hatch',  true , NULL, NULL, NULL, 11006, 0, NULL, NULL,  false ,  false ,  N'mallorie.hatch@asu.edu', NULL, NULL, NULL, 0, 0);
INSERT INTO person (id, contributor, email, first_name, last_name, registered, rpa_number, phone, contributor_reason, institution_id, total_login, last_login, penultimate_login, phone_public, email_public, username, merge_creator_id, proxyinstitution_id, proxy_note, tos_version, contributor_agreement_version) VALUES (60,  true ,  N'matthew.peeples@asu.edu',  N'Matthew',  N'Peeples',  true , NULL, NULL, NULL, 11003, 0, NULL, NULL,  false ,  false ,  N'matthew.peeples@asu.edu', NULL, NULL, NULL, 0, 0);
INSERT INTO person (id, contributor, email, first_name, last_name, registered, rpa_number, phone, contributor_reason, institution_id, total_login, last_login, penultimate_login, phone_public, email_public, username, merge_creator_id, proxyinstitution_id, proxy_note, tos_version, contributor_agreement_version) VALUES (121,  true ,  N'michelle.elliott@asu.edu',  N'Michelle',  N'Elliott',  true , NULL, NULL, NULL, 11003, 0, NULL, NULL,  false ,  false ,  N'michelle.elliott@asu.edu', NULL, NULL, NULL, 0, 0);
INSERT INTO person (id, contributor, email, first_name, last_name, registered, rpa_number, phone, contributor_reason, institution_id, total_login, last_login, penultimate_login, phone_public, email_public, username, merge_creator_id, proxyinstitution_id, proxy_note, tos_version, contributor_agreement_version) VALUES (5349,  true ,  N'joshua.watts@asu.edu',  N'Joshua',  N'Watts',  true , NULL, NULL, NULL, 11019, 0, NULL, NULL,  false ,  false ,  N'joshua.watts@asu.edu', NULL, NULL, NULL, 0, 0);
INSERT INTO person (id, contributor, email, first_name, last_name, registered, rpa_number, phone, contributor_reason, institution_id, total_login, last_login, penultimate_login, phone_public, email_public, username, merge_creator_id, proxyinstitution_id, proxy_note, tos_version, contributor_agreement_version) VALUES (8014,  true ,  N'jdr1@york.ac.uk',  N'Julian',  N'Richards',  true , NULL, NULL, NULL, 11044, 0, NULL, NULL,  false ,  false ,  N'jdr1@york.ac.uk', NULL, NULL, NULL, 0, 0);
INSERT INTO person (id, contributor, email, first_name, last_name, registered, rpa_number, phone, contributor_reason, institution_id, total_login, last_login, penultimate_login, phone_public, email_public, username, merge_creator_id, proxyinstitution_id, proxy_note, tos_version, contributor_agreement_version) VALUES (8018,  true ,  N'smanney@asu.edu',  N'Shelby',  N'Manney',  true , NULL,  N'915-373-0847', NULL, 11006, 0, NULL, NULL,  false ,  false ,  N'smanney@asu.edu', NULL, NULL, NULL, 0, 0);
INSERT INTO person (id, contributor, email, first_name, last_name, registered, rpa_number, phone, contributor_reason, institution_id, total_login, last_login, penultimate_login, phone_public, email_public, username, merge_creator_id, proxyinstitution_id, proxy_note, tos_version, contributor_agreement_version) VALUES (8019,  true ,  N'shelby.manney@asu.edu',  N'Shelby',  N'Manney',  true , NULL,  N'915-373-0847', NULL, 11006, 0, NULL, NULL,  false ,  false ,  N'shelby.manney@asu.edu', NULL, NULL, NULL, 0, 0);
INSERT INTO person (id, contributor, email, first_name, last_name, registered, rpa_number, phone, contributor_reason, institution_id, total_login, last_login, penultimate_login, phone_public, email_public, username, merge_creator_id, proxyinstitution_id, proxy_note, tos_version, contributor_agreement_version) VALUES (8007,  false ,  N'pjwatson@artsci.wustl.edu',  N'Patty Jo',  N'Watson',  false , NULL, NULL, NULL, NULL, 0, NULL, NULL,  false ,  false , NULL, NULL, NULL, NULL, 0, 0);
INSERT INTO person (id, contributor, email, first_name, last_name, registered, rpa_number, phone, contributor_reason, institution_id, total_login, last_login, penultimate_login, phone_public, email_public, username, merge_creator_id, proxyinstitution_id, proxy_note, tos_version, contributor_agreement_version) VALUES (8008,  false ,  N'charles.redman@asu.edu',  N'Charles',  N'Redman',  false , NULL, NULL, NULL, NULL, 0, NULL, NULL,  false ,  false , NULL, NULL, NULL, NULL, 0, 0);
INSERT INTO person (id, contributor, email, first_name, last_name, registered, rpa_number, phone, contributor_reason, institution_id, total_login, last_login, penultimate_login, phone_public, email_public, username, merge_creator_id, proxyinstitution_id, proxy_note, tos_version, contributor_agreement_version) VALUES (8044,  true ,  N'fpmcmanamon@asu.edu',  N'Francis',  N'McManamon',  true , NULL,  N'480-965-6510',  N'Northeastern North America
Historic period
Prehistoric period
Assemblage analysis
Lithic analysis
CRM', 11055, 0, NULL, NULL,  false ,  false ,  N'fpmcmanamon@asu.edu', NULL, NULL, NULL, 0, 0);
INSERT INTO person (id, contributor, email, first_name, last_name, registered, rpa_number, phone, contributor_reason, institution_id, total_login, last_login, penultimate_login, phone_public, email_public, username, merge_creator_id, proxyinstitution_id, proxy_note, tos_version, contributor_agreement_version) VALUES (8067,  true ,  N'candan@asu.edu',  N'K. Selcuk',  N'Candan',  true , NULL, NULL, NULL, 11017, 0, NULL, NULL,  false ,  false ,  N'candan@asu.edu', NULL, NULL, NULL, 0, 0);
INSERT INTO person (id, contributor, email, first_name, last_name, registered, rpa_number, phone, contributor_reason, institution_id, total_login, last_login, penultimate_login, phone_public, email_public, username, merge_creator_id, proxyinstitution_id, proxy_note, tos_version, contributor_agreement_version) VALUES (8161,  true ,  N'kate.spielmann@asu.edu',  N'Katherine',  N'Spielmann',  true , NULL,  N'480-965-7212',  N'North American southwest and eastern united states; prehistoric to early colonial', 11003, 0, NULL, NULL,  false ,  false ,  N'kate.spielmann@asu.edu', NULL, NULL, NULL, 0, 0);
INSERT INTO person (id, contributor, email, first_name, last_name, registered, rpa_number, phone, contributor_reason, institution_id, total_login, last_login, penultimate_login, phone_public, email_public, username, merge_creator_id, proxyinstitution_id, proxy_note, tos_version, contributor_agreement_version) VALUES (8344,  true ,  N'adam.brin@asu.edu',  N'adam',  N'brin',  true , NULL, NULL, NULL, 11055, 0, NULL, NULL,  false ,  false ,  N'adam.brin@asu.edu', NULL, NULL, NULL, 0, 0);
INSERT INTO person (id, contributor, email, first_name, last_name, registered, rpa_number, phone, contributor_reason, institution_id, total_login, last_login, penultimate_login, phone_public, email_public, username, merge_creator_id, proxyinstitution_id, proxy_note, tos_version, contributor_agreement_version) VALUES (8389,  true ,  N'kintigh@tfqa.com',  N'Keith',  N'Kintigh',  true , NULL,  N'480-965-6909',  N'SW US
AD 600-1540', 11150, 0, NULL, NULL,  false ,  false ,  N'kintigh@tfqa.com', NULL, NULL, NULL, 0, 0);
INSERT INTO person (id, contributor, email, first_name, last_name, registered, rpa_number, phone, contributor_reason, institution_id, total_login, last_login, penultimate_login, phone_public, email_public, username, merge_creator_id, proxyinstitution_id, proxy_note, tos_version, contributor_agreement_version) VALUES (8422,  true ,  N'cfennell@illinois.edu',  N'Christopher',  N'Fennell',  true , NULL,  N'217-333-3616',  N'New Philadelphia Archaeology Project, 19th century, Illinois, historical archaeology', 11156, 0, NULL, NULL,  false ,  false ,  N'cfennell@illinois.edu', NULL, NULL, NULL, 0, 0);
--------------------------- site_type_keyword ---------------------------
--------------------------- culture_keyword ---------------------------
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (39, NULL,  N'Cibola',  false , NULL,  false , NULL,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (40, NULL,  N'Zuni',  false , NULL,  false , NULL,  N'ACTIVE', NULL, 0);
INSERT INTO culture_keyword (id, definition, label, approved, index, selectable, parent_id, status, merge_keyword_id, occurrence) VALUES (52, NULL,  N'Sinagua',  false , NULL,  false , NULL,  N'ACTIVE', NULL, 0);
--------------------------- temporal_keyword ---------------------------
...
--------------------------- collection ---------------------------
--------------------------- collection ---------------------------
INSERT INTO collection (id, description, name, updater_id, parent_id, orientation, collection_type, visible, date_created, date_updated, sort_order, owner_id, secondary_sort_order) VALUES (867, NULL, NULL, 6, NULL,  N'LIST',  N'INTERNAL',  false ,  '2011-10-18 14:07:48.434823',  '2013-02-11 16:54:24.923212', NULL, 6, NULL);
INSERT INTO collection (id, description, name, updater_id, parent_id, orientation, collection_type, visible, date_created, date_updated, sort_order, owner_id, secondary_sort_order) VALUES (1095, NULL, NULL, 5349, NULL,  N'LIST',  N'INTERNAL',  false ,  '2011-10-18 14:07:48.434823',  '2013-02-11 16:54:24.923212', NULL, 5349, NULL);
INSERT INTO collection (id, description, name, updater_id, parent_id, orientation, collection_type, visible, date_created, date_updated, sort_order, owner_id, secondary_sort_order) VALUES (1107, NULL, NULL, 6, NULL,  N'LIST',  N'INTERNAL',  false ,  '2011-10-18 14:07:48.434823',  '2013-02-11 16:54:24.923212', NULL, 6, NULL);
INSERT INTO collection (id, description, name, updater_id, parent_id, orientation, collection_type, visible, date_created, date_updated, sort_order, owner_id, secondary_sort_order) VALUES (1205, NULL, NULL, 8161, NULL,  N'LIST',  N'INTERNAL',  false ,  '2011-10-18 14:07:48.434823',  '2013-02-11 16:54:24.923212', NULL, 8161, NULL);
INSERT INTO collection (id, description, name, updater_id, parent_id, orientation, collection_type, visible, date_created, date_updated, sort_order, owner_id, secondary_sort_order) VALUES (1391, NULL, NULL, 8422, NULL,  N'LIST',  N'INTERNAL',  false ,  '2011-10-18 14:07:48.434823',  '2013-02-11 16:54:24.923212', NULL, 8422, NULL);
INSERT INTO collection (id, description, name, updater_id, parent_id, orientation, collection_type, visible, date_created, date_updated, sort_order, owner_id, secondary_sort_order) VALUES (1397, NULL, NULL, 6, NULL,  N'LIST',  N'INTERNAL',  false ,  '2011-10-18 14:07:48.434823',  '2013-02-11 16:54:24.923212', NULL, 6, NULL);
INSERT INTO collection (id, description, name, updater_id, parent_id, orientation, collection_type, visible, date_created, date_updated, sort_order, owner_id, secondary_sort_order) VALUES (1543, NULL, NULL, 6, NULL,  N'LIST',  N'INTERNAL',  false ,  '2011-10-18 14:07:48.434823',  '2013-02-11 16:54:24.923212', NULL, 6, NULL);
INSERT INTO collection (id, description, name, updater_id, parent_id, orientation, collection_type, visible, date_created, date_updated, sort_order, owner_id, secondary_sort_order) VALUES (1552, NULL, NULL, 6, NULL,  N'LIST',  N'INTERNAL',  false ,  '2011-10-18 14:07:48.434823',  '2013-02-11 16:54:24.923212', NULL, 6, NULL);
INSERT INTO collection (id, description, name, updater_id, parent_id, orientation, collection_type, visible, date_created, date_updated, sort_order, owner_id, secondary_sort_order) VALUES (1570, NULL, NULL, 6, NULL,  N'LIST',  N'INTERNAL',  false ,  '2011-10-18 14:07:48.434823',  '2013-02-11 16:54:24.923212', NULL, 6, NULL);
--------------------------- collection_resource ---------------------------
...
INSERT INTO information_resource (id, date_created, project_id, provider_institution_id, last_uploaded, external_reference, resource_language, metadata_language, copy_location, inheriting_investigation_information, inheriting_site_information, inheriting_material_information, inheriting_other_information, inheriting_cultural_information, inheriting_spatial_information, inheriting_temporal_information, mappeddatakeycolumn_id, mappeddatakeyvalue, license_type, license_text, copyright_holder_id, date_created_normalized, inheriting_identifier_information, inheriting_note_information, inheriting_collection_information, publisher_id, publisher_location) VALUES (3794, 2010, 3738, 11154, NULL,  false ,  N'ENGLISH', NULL, NULL,  false ,  false ,  false ,  false ,  false ,  false ,  false , NULL, NULL, NULL, NULL, NULL, 2010,  false ,  false ,  false , NULL, NULL);
INSERT INTO information_resource (id, date_created, project_id, provider_institution_id, last_uploaded, external_reference, resource_language, metadata_language, copy_location, inheriting_investigation_information, inheriting_site_information, inheriting_material_information, inheriting_other_information, inheriting_cultural_information, inheriting_spatial_information, inheriting_temporal_information, mappeddatakeycolumn_id, mappeddatakeyvalue, license_type, license_text, copyright_holder_id, date_created_normalized, inheriting_identifier_information, inheriting_note_information, inheriting_collection_information, publisher_id, publisher_location) VALUES (3029, -1, 3460, NULL, NULL,  false , NULL, NULL, NULL,  false ,  false ,  false ,  false ,  false ,  false ,  false , NULL, NULL, NULL, NULL, NULL, 0,  false ,  false ,  false , NULL, NULL);
INSERT INTO information_resource (id, date_created, project_id, provider_institution_id, last_uploaded, external_reference, resource_language, metadata_language, copy_location, inheriting_investigation_information, inheriting_site_information, inheriting_material_information, inheriting_other_information, inheriting_cultural_information, inheriting_spatial_information, inheriting_temporal_information, mappeddatakeycolumn_id, mappeddatakeyvalue, license_type, license_text, copyright_holder_id, date_created_normalized, inheriting_identifier_information, inheriting_note_information, inheriting_collection_information, publisher_id, publisher_location) VALUES (3087, 2010, 3073, NULL, NULL,  false , NULL, NULL, NULL,  false ,  false ,  false ,  false ,  false ,  false ,  false , NULL, NULL, NULL, NULL, NULL, 2010,  false ,  false ,  false , NULL, NULL);
INSERT INTO information_resource (id, date_created, project_id, provider_institution_id, last_uploaded, external_reference, resource_language, metadata_language, copy_location, inheriting_investigation_information, inheriting_site_information, inheriting_material_information, inheriting_other_information, inheriting_cultural_information, inheriting_spatial_information, inheriting_temporal_information, mappeddatakeycolumn_id, mappeddatakeyvalue, license_type, license_text, copyright_holder_id, date_created_normalized, inheriting_identifier_information, inheriting_note_information, inheriting_collection_information, publisher_id, publisher_location) VALUES (449, 2009, 2420, NULL, NULL,  false , NULL, NULL, NULL,  false ,  false ,  false ,  false ,  false ,  false ,  false , NULL, NULL, NULL, NULL, NULL, 2000,  false ,  false ,  false , NULL, NULL);
INSERT INTO information_resource (id, date_created, project_id, provider_institution_id, last_uploaded, external_reference, resource_language, metadata_language, copy_location, inheriting_investigation_information, inheriting_site_information, inheriting_material_information, inheriting_other_information, inheriting_cultural_information, inheriting_spatial_information, inheriting_temporal_information, mappeddatakeycolumn_id, mappeddatakeyvalue, license_type, license_text, copyright_holder_id, date_created_normalized, inheriting_identifier_information, inheriting_note_information, inheriting_collection_information, publisher_id, publisher_location) VALUES (3479, -1, 3462, NULL, NULL,  false , NULL, NULL, NULL,  false ,  false ,  false ,  false ,  false ,  false ,  false , NULL, NULL, NULL, NULL, NULL, 0,  false ,  false ,  false , NULL, NULL);
INSERT INTO information_resource (id, date_created, project_id, provider_institution_id, last_uploaded, external_reference, resource_language, metadata_language, copy_location, inheriting_investigation_information, inheriting_site_information, inheriting_material_information, inheriting_other_information, inheriting_cultural_information, inheriting_spatial_information, inheriting_temporal_information, mappeddatakeycolumn_id, mappeddatakeyvalue, license_type, license_text, copyright_holder_id, date_created_normalized, inheriting_identifier_information, inheriting_note_information, inheriting_collection_information, publisher_id, publisher_location) VALUES (3167, -1, 3073, NULL, NULL,  false , NULL, NULL, NULL,  false ,  false ,  false ,  false ,  false ,  false ,  false , NULL, NULL, NULL, NULL, NULL, 0,  false ,  false ,  false , NULL, NULL);
INSERT INTO information_resource (id, date_created, project_id, provider_institution_id, last_uploaded, external_reference, resource_language, metadata_language, copy_location, inheriting_investigation_information, inheriting_site_information, inheriting_material_information, inheriting_other_information, inheriting_cultural_information, inheriting_spatial_information, inheriting_temporal_information, mappeddatakeycolumn_id, mappeddatakeyvalue, license_type, license_text, copyright_holder_id, date_created_normalized, inheriting_identifier_information, inheriting_note_information, inheriting_collection_information, publisher_id, publisher_location) VALUES (1656, -1, 1628, NULL, NULL,  false , NULL, NULL, NULL,  false ,  false ,  false ,  false ,  false ,  false ,  false , NULL, NULL, NULL, NULL, NULL, 0,  false ,  false ,  false , NULL, NULL);
INSERT INTO information_resource (id, date_created, project_id, provider_institution_id, last_uploaded, external_reference, resource_language, metadata_language, copy_location, inheriting_investigation_information, inheriting_site_information, inheriting_material_information, inheriting_other_information, inheriting_cultural_information, inheriting_spatial_information, inheriting_temporal_information, mappeddatakeycolumn_id, mappeddatakeyvalue, license_type, license_text, copyright_holder_id, date_created_normalized, inheriting_identifier_information, inheriting_note_information, inheriting_collection_information, publisher_id, publisher_location) VALUES (4287, 1988, 4279, 11055, NULL,  false ,  N'ENGLISH', NULL,  N'Montezuma Castle National Monument, Western Archeological and Conservation Center',  false ,  false ,  false ,  false ,  false ,  false ,  false , NULL, NULL, NULL, NULL, NULL, 1980,  false ,  false ,  false , 11169,  N'Tucson, Arizona');
INSERT INTO information_resource (id, date_created, project_id, provider_institution_id, last_uploaded, external_reference, resource_language, metadata_language, copy_location, inheriting_investigation_information, inheriting_site_information, inheriting_material_information, inheriting_other_information, inheriting_cultural_information, inheriting_spatial_information, inheriting_temporal_information, mappeddatakeycolumn_id, mappeddatakeyvalue, license_type, license_text, copyright_holder_id, date_created_normalized, inheriting_identifier_information, inheriting_note_information, inheriting_collection_information, publisher_id, publisher_location) VALUES (3074, 2010, 3073, NULL, NULL,  false ,  N'ENGLISH', NULL, NULL,  false ,  false ,  false ,  false ,  false ,  false ,  false , NULL, NULL, NULL, NULL, NULL, 2010,  false ,  false ,  false , NULL, NULL);
INSERT INTO information_resource (id, date_created, project_id, provider_institution_id, last_uploaded, external_reference, resource_language, metadata_language, copy_location, inheriting_investigation_information, inheriting_site_information, inheriting_material_information, inheriting_other_information, inheriting_cultural_information, inheriting_spatial_information, inheriting_temporal_information, mappeddatakeycolumn_id, mappeddatakeyvalue, license_type, license_text, copyright_holder_id, date_created_normalized, inheriting_identifier_information, inheriting_note_information, inheriting_collection_information, publisher_id, publisher_location) VALUES (3088, 2010, 3073, NULL, NULL,  false ,  N'ENGLISH', NULL, NULL,  false ,  false ,  false ,  false ,  false ,  false ,  false , NULL, NULL, NULL, NULL, NULL, 2010,  false ,  false ,  false , NULL, NULL);
INSERT INTO information_resource (id, date_created, project_id, provider_institution_id, last_uploaded, external_reference, resource_language, metadata_language, copy_location, inheriting_investigation_information, inheriting_site_information, inheriting_material_information, inheriting_other_information, inheriting_cultural_information, inheriting_spatial_information, inheriting_temporal_information, mappeddatakeycolumn_id, mappeddatakeyvalue, license_type, license_text, copyright_holder_id, date_created_normalized, inheriting_identifier_information, inheriting_note_information, inheriting_collection_information, publisher_id, publisher_location) VALUES (4230, 2008, 3805, NULL, NULL,  false ,  N'ENGLISH', NULL, NULL,  false ,  false ,  false ,  false ,  false ,  false ,  false , NULL, NULL, NULL, NULL, NULL, 2000,  false ,  false ,  false , NULL, NULL);
INSERT INTO information_resource (id, date_created, project_id, provider_institution_id, last_uploaded, external_reference, resource_language, metadata_language, copy_location, inheriting_investigation_information, inheriting_site_information, inheriting_material_information, inheriting_other_information, inheriting_cultural_information, inheriting_spatial_information, inheriting_temporal_information, mappeddatakeycolumn_id, mappeddatakeyvalue, license_type, license_text, copyright_holder_id, date_created_normalized, inheriting_identifier_information, inheriting_note_information, inheriting_collection_information, publisher_id, publisher_location) VALUES (4231, 2008, 3805, NULL, NULL,  false ,  N'ENGLISH', NULL, NULL,  false ,  false ,  false ,  false ,  false ,  false ,  false , NULL, NULL, NULL, NULL, NULL, 2000,  false ,  false ,  false , NULL, NULL);
INSERT INTO information_resource (id, date_created, project_id, provider_institution_id, last_uploaded, external_reference, resource_language, metadata_language, copy_location, inheriting_investigation_information, inheriting_site_information, inheriting_material_information, inheriting_other_information, inheriting_cultural_information, inheriting_spatial_information, inheriting_temporal_information, mappeddatakeycolumn_id, mappeddatakeyvalue, license_type, license_text, copyright_holder_id, date_created_normalized, inheriting_identifier_information, inheriting_note_information, inheriting_collection_information, publisher_id, publisher_location) VALUES (4232, 2008, 3805, NULL, NULL,  false ,  N'ENGLISH', NULL, NULL,  false ,  false ,  false ,  false ,  false ,  false ,  false , NULL, NULL, NULL, NULL, NULL, 2000,  false ,  false ,  false , NULL, NULL);
--------------------------- information_resource_file ---------------------------
INSERT INTO information_resource_file (id, general_type, latest_version, sequence_number, information_resource_id, status, number_of_parts, restriction, date_made_public, error_message, part_of_composite, description, file_created_date) VALUES (730,  N'DOCUMENT', 0, 0, 4287, NULL, NULL,  N'CONFIDENTIAL', NULL, NULL,  false , NULL, NULL);
INSERT INTO information_resource_file (id, general_type, latest_version, sequence_number, information_resource_id, status, number_of_parts, restriction, date_made_public, error_message, part_of_composite, description, file_created_date) VALUES (689,  N'DOCUMENT', 0, 0, 4230, NULL, NULL,  N'PUBLIC', NULL, NULL,  false , NULL, NULL);
INSERT INTO information_resource_file (id, general_type, latest_version, sequence_number, information_resource_id, status, number_of_parts, restriction, date_made_public, error_message, part_of_composite, description, file_created_date) VALUES (691,  N'DOCUMENT', 0, 0, 4232, NULL, NULL,  N'PUBLIC', NULL, NULL,  false , NULL, NULL);
INSERT INTO information_resource_file (id, general_type, latest_version, sequence_number, information_resource_id, status, number_of_parts, restriction, date_made_public, error_message, part_of_composite, description, file_created_date) VALUES (690,  N'DOCUMENT', 0, 0, 4231, NULL, NULL,  N'PUBLIC', NULL, NULL,  false , NULL, NULL);
INSERT INTO information_resource_file (id, general_type, latest_version, sequence_number, information_resource_id, status, number_of_parts, restriction, date_made_public, error_message, part_of_composite, description, file_created_date) VALUES (124,  N'COLUMNAR_DATA', 0, 0, 1656,  N'PROCESSED', NULL,  N'PUBLIC', NULL, NULL,  false , NULL, NULL);
INSERT INTO information_resource_file (id, general_type, latest_version, sequence_number, information_resource_id, status, number_of_parts, restriction, date_made_public, error_message, part_of_composite, description, file_created_date) VALUES (285,  N'COLUMNAR_DATA', 0, 0, 449, NULL, NULL,  N'PUBLIC', NULL, NULL,  false , NULL, NULL);
INSERT INTO information_resource_file (id, general_type, latest_version, sequence_number, information_resource_id, status, number_of_parts, restriction, date_made_public, error_message, part_of_composite, description, file_created_date) VALUES (45,  N'COLUMNAR_DATA', 0, 0, 3088,  N'PROCESSED', NULL,  N'PUBLIC', NULL, NULL,  false , NULL, NULL);
INSERT INTO information_resource_file (id, general_type, latest_version, sequence_number, information_resource_id, status, number_of_parts, restriction, date_made_public, error_message, part_of_composite, description, file_created_date) VALUES (354,  N'OTHER', 0, 0, 3479, NULL, NULL,  N'PUBLIC', NULL, NULL,  false , NULL, NULL);
INSERT INTO information_resource_file (id, general_type, latest_version, sequence_number, information_resource_id, status, number_of_parts, restriction, date_made_public, error_message, part_of_composite, description, file_created_date) VALUES (490,  N'OTHER', 0, 0, 3029, NULL, NULL,  N'PUBLIC', NULL, NULL,  false , NULL, NULL);
INSERT INTO information_resource_file (id, general_type, latest_version, sequence_number, information_resource_id, status, number_of_parts, restriction, date_made_public, error_message, part_of_composite, description, file_created_date) VALUES (41,  N'COLUMNAR_DATA', 0, 0, 3074,  N'PROCESSED', NULL,  N'PUBLIC', NULL, NULL,  false , NULL, NULL);
INSERT INTO information_resource_file (id, general_type, latest_version, sequence_number, information_resource_id, status, number_of_parts, restriction, date_made_public, error_message, part_of_composite, description, file_created_date) VALUES (416,  N'DOCUMENT', 0, 0, 3794, NULL, NULL,  N'EMBARGOED',  '2015-07-22 14:03:57.731', NULL,  false , NULL, NULL);
...
--HACK FIXME:this is just a temporary test to see if indexing fk source columns has any effect on build times
create index on authorized_user (resource_collection_id);
create index on authorized_user (user_id);
create index on bookmarked_resource (person_id);
create index on bookmarked_resource (resource_id);
create index on category_variable (parent_id);
create index on category_variable_synonyms (categoryvariable_id);
create index on coding_rule (coding_sheet_id);
create index on coding_rule (ontology_node_id);
create index on coding_sheet (category_variable_id);
create index on coding_sheet (default_ontology_id);
create index on collection (owner_id);
create index on collection (parent_id);
create index on collection (updater_id);
create index on contributor_request (applicant_id);
create index on contributor_request (approver_id);
create index on coverage_date (resource_id);
create index on creator_address (creator_id);
create index on culture_keyword (merge_keyword_id);
create index on culture_keyword (parent_id);
create index on data_table (dataset_id);
create index on data_table_column (category_variable_id);
create index on data_table_column (data_table_id);
create index on data_table_column (default_coding_sheet_id);
create index on data_table_column (default_ontology_id);
create index on data_table_column_relationship (foreign_column_id);
create index on data_table_column_relationship (local_column_id);
create index on data_table_column_relationship (relationship_id);
create index on data_table_relationship (dataset_id);
create index on geographic_keyword (merge_keyword_id);
create index on homepage_featured_item_cache (resource_id);
create index on information_resource (copyright_holder_id);
create index on information_resource (mappeddatakeycolumn_id);
create index on information_resource (project_id);
create index on information_resource (provider_institution_id);
create index on information_resource (publisher_id);
create index on information_resource_file (information_resource_id);
create index on information_resource_file_download_statistics (information_resource_file_id);
create index on institution (merge_creator_id);
create index on institution (parentinstitution_id);
create index on investigation_type (merge_keyword_id);
create index on latitude_longitude (resource_id);
create index on material_keyword (merge_keyword_id);
create index on ontology (category_variable_id);
create index on ontology_node (ontology_id);
create index on ontology_node_synonym (ontologynode_id);
create index on other_keyword (merge_keyword_id);
create index on person (institution_id);
create index on person (merge_creator_id);
create index on person (proxyinstitution_id);
create index on personal_filestore_ticket (submitter_id);
create index on pos_account (account_group_id);
create index on pos_account (modifier_id);
create index on pos_account (owner_id);
create index on pos_account_group (modifier_id);
create index on pos_account_group (owner_id);
create index on pos_billing_activity (model_id);
create index on pos_coupon (account_id);
create index on pos_coupon (user_id);
create index on pos_invoice (account_id);
create index on pos_invoice (address_id);
create index on pos_invoice (coupon_id);
create index on pos_invoice (executor_id);
create index on pos_invoice (owner_id);
create index on pos_invoice (response_id);
create index on pos_item (activity_id);
create index on pos_item (invoice_id);
create index on related_comparative_collection (resource_id);
create index on resource (account_id);
create index on resource (submitter_id);
create index on resource (updater_id);
create index on resource (uploader_id);
create index on resource_access_statistics (resource_id);
create index on resource_annotation (resource_id);
create index on resource_annotation (resourceannotationkey_id);
create index on resource_creator (creator_id);
create index on resource_creator (resource_id);
create index on resource_note (resource_id);
create index on resource_relationship (sourceresource_id);
create index on resource_relationship (targetresource_id);
create index on resource_revision_log (person_id);
create index on sensory_data_image (sensory_data_id);
create index on sensory_data_scan (sensory_data_id);
create index on site_name_keyword (merge_keyword_id);
create index on site_type_keyword (merge_keyword_id);
create index on site_type_keyword (parent_id);
create index on source_collection (resource_id);
create index on temporal_keyword (merge_keyword_id);
create index on user_session (person_id);
