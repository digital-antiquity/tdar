...
public class DocumentFileITCase extends AbstractIntegrationTestCase {
    ...
    public void testBrokenImageStatus() throws Exception {
        ...
        boolean result = messageService.sendFileProcessingRequest(workflow, resource, informationResourceFile, originalVersion);
    ...
    public void testRTFTextExtraction() throws Exception {
        ...
        indexableVersion.setInformationResourceFileId(informationResourceFile.getId());
        indexableVersion.setInformationResourceId(resource.getId());
