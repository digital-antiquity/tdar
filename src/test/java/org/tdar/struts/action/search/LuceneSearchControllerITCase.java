...
public class LuceneSearchControllerITCase extends AbstractSearchControllerITCase {
    ...
    public void testFindAllSearchPhrase() {
        doSearch("");
        assertEquals(LuceneSearchController.SEARCHING_ALL_RESOURCE_TYPES, controller.getSearchPhrase());
        assertEquals(LuceneSearchController.TITLE_ALL_RECORDS, controller.getSearchSubtitle());
    }
    ...
    public void testFindResourceTypePhrase() {
        ...
        assertEquals(controller.getSearchSubtitle(), LuceneSearchController.TITLE_ALL_RECORDS);
    }
    ...
    public void testCultureKeywordSearch() {
        ...
        assertTrue(searchPhrase.contains(LuceneSearchController.SELECTED_RESOURCE_TYPES + " "));
