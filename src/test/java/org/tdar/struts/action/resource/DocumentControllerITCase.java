...
public class DocumentControllerITCase extends AbstractResourceControllerITCase {
    ...
    public void testOpenURLGeneration() throws TdarActionException {
        ...
        assertEquals(
                "ctx_ver=Z39.88-2004&amp;rfr_id=info:sid/"+TestConfiguration.getInstance().getBaseUrl()+"&amp;rft_val_fmt=info:ofi/fmt:kev:mtx:unknown&amp;rft.genre=unknown&amp;rft.title=2008+New+Philadelphia+Archaeology+Report%2C+Chapter+3%2C+Block+3%2C+Lot+4",
                openUrl);
    }
