...
public class DocumentControllerITCase extends AbstractAdminControllerITCase {
    ...
    public void testEditResourceCreators() {
        ...
        getLogger().debug(controller.getAuthorshipProxies().size());
    ...
    @Test
    @Rollback
    public void testResourceCreatorNotCreated() {
        // FIXME: implement me.
    }
