...
public enum SortOption {
    RELEVANCE(null, "Relevance", null, SortField.Type.SCORE, false),
    ID(null, "ID", QueryFieldNames.ID, SortField.Type.INT, false),
    ID_REVERSE(null, "ID (Most Recent)", QueryFieldNames.ID, SortField.Type.INT, true),
    ...
    DATE(Resource.class, "Date", QueryFieldNames.DATE, SortField.Type.STRING, false),
    DATE_REVERSE(Resource.class, "Date (Most Recent)", QueryFieldNames.DATE, SortField.Type.STRING, true),
    DATE_UPDATED(Resource.class, "Date Updated", QueryFieldNames.DATE_UPDATED, SortField.Type.STRING, false),
    DATE_UPDATED_REVERSE(Resource.class, "Date Updated (Most Recent)", QueryFieldNames.DATE_UPDATED, SortField.Type.STRING, true),
    ...
    private SortOption(Class<? extends Indexable> context, String label, String sortField, boolean reversed) {
        this(context, label, sortField, SortField.Type.STRING, reversed);
    }

    private SortOption(Class<? extends Indexable> context, String label, String sortField, Type sortType, boolean reversed) {
        this.setLabel(label);
     ...
     */
    public void setLuceneSortType(Type luceneSortType) {
