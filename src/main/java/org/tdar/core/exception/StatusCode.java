 ...
 * $Id$
 * 
 * Represents an http response that encapsulates a status code, error message, and result name for our web layer {@see SessionSecurityInterceptor} 
 * to dispatch appropriately.  You can override the default result via withResultName().
 * 
