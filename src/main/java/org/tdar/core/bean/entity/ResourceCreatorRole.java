...
public enum ResourceCreatorRole implements HasLabel {
    CONTACT(MessageHelper.getMessage("resourceCreatorRole.contact"), ResourceCreatorRoleType.CREDIT),
    AUTHOR(MessageHelper.getMessage("resourceCreatorRole.author"), ResourceCreatorRoleType.AUTHORSHIP, null, ResourceType.DOCUMENT),
    CONTRIBUTOR(MessageHelper.getMessage("resourceCreatorRole.contributor"), ResourceCreatorRoleType.CREDIT),
    EDITOR(MessageHelper.getMessage("resourceCreatorRole.editor"), ResourceCreatorRoleType.AUTHORSHIP, CreatorType.PERSON, ResourceType.DOCUMENT),
    TRANSLATOR(MessageHelper.getMessage("resourceCreatorRole.translator"), ResourceCreatorRoleType.CREDIT, CreatorType.PERSON, ResourceType.DOCUMENT),
    FIELD_DIRECTOR(MessageHelper.getMessage("resourceCreatorRole.field_director"), ResourceCreatorRoleType.CREDIT, CreatorType.PERSON),
    LAB_DIRECTOR(MessageHelper.getMessage("resourceCreatorRole.lab_director"), ResourceCreatorRoleType.CREDIT, CreatorType.PERSON),
    PRINCIPAL_INVESTIGATOR(MessageHelper.getMessage("resourceCreatorRole.principal_investigator"), ResourceCreatorRoleType.CREDIT, CreatorType.PERSON),
    PROJECT_DIRECTOR(MessageHelper.getMessage("resourceCreatorRole.project_director"), ResourceCreatorRoleType.CREDIT, CreatorType.PERSON),
    COLLABORATOR(MessageHelper.getMessage("resourceCreatorRole.collaborator"), ResourceCreatorRoleType.CREDIT, CreatorType.INSTITUTION),
    LANDOWNER(MessageHelper.getMessage("resourceCreatorRole.landowner"), ResourceCreatorRoleType.CREDIT),
    SPONSOR(MessageHelper.getMessage("resourceCreatorRole.sponsor"), ResourceCreatorRoleType.CREDIT),
    PERMITTER(MessageHelper.getMessage("resourceCreatorRole.permitter"), ResourceCreatorRoleType.CREDIT, CreatorType.INSTITUTION),
    REPOSITORY(MessageHelper.getMessage("resourceCreatorRole.repository"), ResourceCreatorRoleType.CREDIT, CreatorType.INSTITUTION),
    CREATOR(MessageHelper.getMessage("resourceCreatorRole.creator"), ResourceCreatorRoleType.AUTHORSHIP, null, ResourceType.CODING_SHEET, ResourceType.ONTOLOGY, ResourceType.IMAGE, ResourceType.DATASET,
            ResourceType.SENSORY_DATA, ResourceType.ARCHIVE, ResourceType.GEOSPATIAL, ResourceType.VIDEO, ResourceType.AUDIO),
    PREPARER(MessageHelper.getMessage("resourceCreatorRole.preparer"), ResourceCreatorRoleType.CREDIT, CreatorType.INSTITUTION),
    SUBMITTED_TO(MessageHelper.getMessage("resourceCreatorRole.submitted_to"), ResourceCreatorRoleType.CREDIT, CreatorType.INSTITUTION),
    COPYRIGHT_HOLDER(MessageHelper.getMessage("resourceCreatorRole.copyright_holder"), ResourceCreatorRoleType.OTHER, null, ResourceType.CODING_SHEET, ResourceType.ONTOLOGY, ResourceType.IMAGE,
    ...
    SUBMITTER(MessageHelper.getMessage("resourceCreatorRole.submitter"), ResourceCreatorRoleType.OTHER, CreatorType.PERSON),
    UPDATER(MessageHelper.getMessage("resourceCreatorRole.updater"), ResourceCreatorRoleType.OTHER, CreatorType.PERSON),
    RESOURCE_PROVIDER(MessageHelper.getMessage("resourceCreatorRole.resource_provider"), ResourceCreatorRoleType.OTHER, CreatorType.INSTITUTION),
    PUBLISHER(MessageHelper.getMessage("resourceCreatorRole.publisher"), ResourceCreatorRoleType.OTHER);
    /*
     * SUGGESTIONS FOR:
     * Crew Chief
