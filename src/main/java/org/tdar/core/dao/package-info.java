...
@org.hibernate.annotations.NamedQueries({
    ...
    @org.hibernate.annotations.NamedQuery(
            ...
            query="select res from ResourceProxy res fetch all properties left join fetch res.informationResourceFileProxies file where res.status in (:statuses) and res.submitter=:submitterId and file.status in (:fileStatuses)"
            ),
    @org.hibernate.annotations.NamedQuery(
