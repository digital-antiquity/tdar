...
public class CodingSheetService extends AbstractInformationResourceService<CodingSheet, CodingSheetDao> {
    ...
    public List<CodingSheet> findSparseCodingSheetListBySubmitter(Person submitter) {
        return getDao().findSparseResourceBySubmitterType(submitter, ResourceType.CODING_SHEET);
    }
