...
public class SpringLdapService extends BaseAuthenticationProvider {
    ...
    public boolean addUser(Person person, String password) {
        ...
        try {
            Person temp = ldapDAO.findByPrimaryKey(email);
        ...
        logger.debug("Adding LDAP user : " + email);
    ...
    public String[] findGroupMemberships(String email) {
        PersonLdapDao ldapDAO = new PersonLdapDao();
        return ldapDAO.getGroupMembership(email);
    }
    ...
    public class PersonLdapDao {
        ...
        public void create(Person person, String password) {
        ...
        private void addUserToGroup(Person person, String groupName) {
            try {
                ...
                groupContext.addAttributeValue(ATTR_MEMBER, person.getEmail());
        ...
        protected Name buildPersonRDN(Person person) {
            return buildPersonRDN(person.getEmail());
        }
        ...
        private Name buildPersonDN(Person person) throws InvalidNameException {
            return buildPersonDN(person.getEmail());
        }
