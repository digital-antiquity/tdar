...
public interface TagGatewayPort {
    ...
    @ResponseWrapper(localName = "GetTopRecordsResponse", targetNamespace = "http://archaeologydataservice.ac.uk/tag/schema", className = "org.tdar.tag.GetTopRecordsResponse")
    public SearchResults getTopRecords(
        @WebParam(name = "sessionId", targetNamespace = "")
        String sessionId,
        @WebParam(name = "Query", targetNamespace = "http://archaeologydataservice.ac.uk/tag/schema")
        Query query,
        @WebParam(name = "numberOfRecords", targetNamespace = "")
        int numberOfRecords);
    ...
    public GetXsltTemplateResponse getXsltTemplate(
        @WebParam(name = "GetXsltTemplate", targetNamespace = "http://archaeologydataservice.ac.uk/tag/schema", partName = "parameters")
        GetXsltTemplate parameters);
    ...
    @ResponseWrapper(localName = "GetVersionResponse", targetNamespace = "http://archaeologydataservice.ac.uk/tag/schema", className = "org.tdar.tag.GetVersionResponse")
