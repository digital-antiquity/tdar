...
@Component
@Scope("prototype")
public class DataOneController extends AbstractLookupController<Indexable> implements ParameterNameAware {

    private static final long serialVersionUID = 599153179961987932L;
