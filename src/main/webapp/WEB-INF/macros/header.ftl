...
<!--[if lte IE 8]><script language="javascript" type="text/javascript" src="<@s.url value="/includes/Jit-2.0.1/Extras/excanvas.js"/>"></script><![endif]--> 
    ...
    <#local srcs = [
                     ...
                     "/includes/blueimp-jquery-file-upload-5.28.5/js/vendor/jquery.ui.widget.js", 
                     "/includes/blueimp-jquery-file-upload-5.28.5/js/jquery.iframe-transport.js", 
                     "/includes/blueimp-jquery-file-upload-5.28.5/js/jquery.fileupload.js",
                     "/includes/blueimp-jquery-file-upload-5.28.5/js/jquery.fileupload-fp.js",
                     "/includes/blueimp-jquery-file-upload-5.28.5/js/jquery.fileupload-ui.js",
