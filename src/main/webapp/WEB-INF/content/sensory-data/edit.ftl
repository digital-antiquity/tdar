...
<div class="glide" id="divSurveyInfo">
    ...
    <!--TODO:add jquery validator for java short date format, which struts expects -->
    <span tiplabel="Survey Date(s)" tooltipcontent="Date of survey, or date range of survey.">
        ...
        <input type="text" id="txtSurveyDateBegin" name="sensoryData.surveyDateBegin" class="shortfield date watermarked" watermark="mm/dd/yyyy"
        ...
        <input type="text" id="txtSurveyDateEnd" name="sensoryData.surveyDateEnd" class="right-shortfield date watermarked" watermark="mm/dd/yyyy"
