...
href='http://dev.tdar.org/jira'>issue tracker</a> to see if it has already been
reported - if not, please enter the error messages listed below into our <a
href='http://dev.tdar.org/jira'>issue tracker</a> along with any relevant details of
...
where you can ask questions pertaining to the development or usage of tDAR.
</p>
<h2>Exception stack trace (please copy and paste this into the bug report)</h2>
