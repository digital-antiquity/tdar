...
<#macro citationInformation>
    ...
    <div class="doctypeToggle book_section"     data-tooltipcontent="Enter the title of the book, report, or journal this document is part of." data-tiplabel="Additional Title" id="t-book-title">
    ...
    <div id="t-isbn" placeholder="XXXX-XXXX" data-tiplabel="ISBN" data-tooltipcontent="International Standard Book Number." class="book_section book other doctypeToggle">
    ...
    <div id="t-issn" placeholder="XXXX-XXXX" data-tiplabel="ISSN" data-tooltipcontent="International Standard Serial Number, an eight-digit number assigned to many serial publications." class="journal_article doctypeToggle">
