...
<div class="row">
	...
	<div class="span3">
		<h2>Advanced</h2>
		<p>If you've used the bulk upload tool before, or already have a template that you know works, <a href="<@s.url value="add?projectId=${(projectId_!-1)?c}"/>">skip to the upload form</a>.
	</div>
</div>
