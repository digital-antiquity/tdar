...
<style>
#map_legend {position: relative;right:-315px;top:-21px;background-color: #EEE;display: block;width:230px;height:1.8em}
.legendText  {padding-top:0px !important;margin-left:5px;margin-right:5px}
.legendBox , .legendText {clear:none;float:left;} 
.legendBox {border:1px solid #666666;width:10px;margin-top:3px;height:10px;padding:2px;}
</style>
