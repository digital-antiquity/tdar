        ...
        $('#file_upload').fileUploadUI({
            ...
            buildUploadRow: function (files, index) {
                ...
                if (index) { //browser doesn't support multi-file uploads, so this callback called once per fiile
                    ...
                    return $('<tr><td> Uploading ' + files.length + ' files<\/td>' + '<td class="file_upload_progress"><div><\/div><\/td>' + '<td class="file_upload_cancel">' + '<button class="ui-state-default ui-corner-all" title="Cancel">' + '<span class="ui-icon ui-icon-cancel">Cancel<\/span>' + '<\/button><\/td><\/tr>');
                }
