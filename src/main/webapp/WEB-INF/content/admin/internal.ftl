	...
	<table class="tableFormat table">
      <tr>
       ...
       <#list recentlyUpdatedResources as resource>
         ...
         <tr>
         <td/>
           <td colspan=2><small>created on ${resource.dateCreated} by <a href="<@s.url value="/browse/creators/${resource.submitter.id?c}"/>">${resource.submitter.properName}</a>; 
                                updated on  ${resource.dateUpdated} by <a href="<@s.url value="/browse/creators/${resource.updatedBy.id?c}"/>">${resource.updatedBy.properName}</a></small></td>
         </tr>
       </#list>
    </table>
</div>
