...
<p>
    ...
    Note that deleted resources remain archived in tDAR, and users with access rights to deleted documents
    ...
    access to the deleted content,  please contact us at <a href="mailto:comments@tdar.org">comments@tdar.org</a>.
    </#if>
</p>
