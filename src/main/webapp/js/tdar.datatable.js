...
//
     ...
     * Currency detection courtesy of Allan Jardine, Nuno Gomes (http://http://legacy.datatables.net/plug-ins/type-detection)
     * @private
     */
    function _extendSorting() {
        ...
        function _fnCurrencyDetect(sData) {
            if(typeof data !== "string" || _reDetect.test(sData)) {
                return null;
            }
            return "tdar-currency";
        }
