        ...
        var fileUpload = this,
            ...
            createProgressEvent = function (lengthComputable, loaded, total) {
                ...
                if (typeof document.createEvent === func && typeof ProgressEvent !== undef) {
                    //HACK: newer versions of chrome have deprecated initProgressEvent.  this is a temporary workaround
                    //      until we can upgrade to newer jquery.fileupload version that doesn't have this bug.
                    if(typeof ProgressEvent.prototype.initProgressEvent !== undef) {
                        ...
                        //HACK: use newer webkit ProgressEvent constructor if initProgressEvent not available.  The docs for this are scant at best.  I'm mostly guessing here
                        // based on  chromium bug reports and non-english forum posts.  I don't think we can monkeypatch in a custom
                        // initProgressEvent()  because in chrome the properties are read-only and can't be changed after instantiation.
                        event = new ProgressEvent('progress', {"bubbles": false, 
                                        "cancelable": false,
