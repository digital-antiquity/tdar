...
-- Started on 2012-07-26 11:10:31
...
--
-- TOC entry 163 (class 1259 OID 78993)
-- Dependencies: 6
...
--
-- TOC entry 164 (class 1259 OID 78999)
-- Dependencies: 6 163
...
SELECT pg_catalog.setval('culture_keyword_id_seq', 10001, true);


--
-- TOC entry 176 (class 1259 OID 79050)
-- Dependencies: 6
...
--
-- TOC entry 177 (class 1259 OID 79056)
-- Dependencies: 6 176
...
-- Dependencies: 177
-- Name: geographic_keyword_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tdar
--

SELECT pg_catalog.setval('geographic_keyword_id_seq', 3249, true);


--
-- TOC entry 190 (class 1259 OID 79106)
-- Dependencies: 6
...
--
-- TOC entry 191 (class 1259 OID 79112)
-- Dependencies: 6 190
...
SELECT pg_catalog.setval('investigation_type_id_seq', 16, true);


--
-- TOC entry 194 (class 1259 OID 79120)
-- Dependencies: 6
...
--
-- TOC entry 195 (class 1259 OID 79126)
-- Dependencies: 6 194
...
SELECT pg_catalog.setval('material_keyword_id_seq', 21, true);


--
-- TOC entry 238 (class 1259 OID 79304)
-- Dependencies: 6
...
--
-- TOC entry 239 (class 1259 OID 79310)
-- Dependencies: 6 238
...
SELECT pg_catalog.setval('site_type_keyword_id_seq', 429, true);


--
-- TOC entry 244 (class 1259 OID 79328)
-- Dependencies: 6
...
--
-- TOC entry 245 (class 1259 OID 79334)
-- Dependencies: 244 6
...
-- Dependencies: 245
-- Name: temporal_keyword_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tdar
--

SELECT pg_catalog.setval('temporal_keyword_id_seq', 243, true);


--
-- TOC entry 2136 (class 2604 OID 80019)
...
--
-- TOC entry 2137 (class 2604 OID 80022)
...
--
-- TOC entry 2138 (class 2604 OID 80024)
...
--
-- TOC entry 2139 (class 2604 OID 80025)
...
--
-- TOC entry 2140 (class 2604 OID 80037)
...
--
-- TOC entry 2141 (class 2604 OID 80040)
...
--
-- TOC entry 2145 (class 2606 OID 79405)
...
--
-- TOC entry 2151 (class 2606 OID 79423)
...
--
-- TOC entry 2155 (class 2606 OID 79443)
...
--
-- TOC entry 2157 (class 2606 OID 79447)
...
--
-- TOC entry 2161 (class 2606 OID 79503)
...
--
-- TOC entry 2164 (class 2606 OID 79505)
...
--
-- TOC entry 2147 (class 2606 OID 79507)
-- Dependencies: 163 163
...
--
-- TOC entry 2153 (class 2606 OID 79509)
-- Dependencies: 176 176
...
--
-- TOC entry 2167 (class 2606 OID 79515)
-- Dependencies: 244 244
...
--
-- TOC entry 2142 (class 1259 OID 79522)
-- Dependencies: 163 163
...
--
-- TOC entry 2143 (class 1259 OID 79527)
-- Dependencies: 163 163
...
--
-- TOC entry 2148 (class 1259 OID 79531)
...
--
-- TOC entry 2149 (class 1259 OID 79532)
-- Dependencies: 176 176
...
--
-- TOC entry 2158 (class 1259 OID 79566)
-- Dependencies: 238
...
--
-- TOC entry 2159 (class 1259 OID 79567)
-- Dependencies: 238 238
...
--
-- TOC entry 2162 (class 1259 OID 79568)
-- Dependencies: 238 238
...
--
-- TOC entry 2165 (class 1259 OID 79569)
-- Dependencies: 244 244
...
--
-- TOC entry 2168 (class 2606 OID 79590)
-- Dependencies: 163 163 2144
...
--
-- TOC entry 2169 (class 2606 OID 91251)
-- Dependencies: 163 163 2144
-- Name: culture_keyword_parent_id_fkey1; Type: FK CONSTRAINT; Schema: public; Owner: tdar
--

ALTER TABLE ONLY culture_keyword
    ADD CONSTRAINT culture_keyword_parent_id_fkey1 FOREIGN KEY (parent_id) REFERENCES culture_keyword(id);


--
-- TOC entry 2170 (class 2606 OID 80000)
-- Dependencies: 2160 238 238
...
--
-- TOC entry 2171 (class 2606 OID 91256)
-- Dependencies: 2160 238 238
-- Name: site_type_keyword_parent_id_fkey1; Type: FK CONSTRAINT; Schema: public; Owner: tdar
--

ALTER TABLE ONLY site_type_keyword
    ADD CONSTRAINT site_type_keyword_parent_id_fkey1 FOREIGN KEY (parent_id) REFERENCES site_type_keyword(id);


-- Completed on 2012-07-26 11:10:31
