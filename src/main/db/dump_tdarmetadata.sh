...
pg_dump -a --disable-triggers  -U tdar -T category_variable -T category_variable_synonyms -T culture_keyword -T culture_keyword_synonym -T investigation_type -T investigation_type_synonym -T material_keyword -T material_keyword_synonym -T site_type_keyword -T site_type_keyword_synonym tdarmetadata > tdarmetadata_sample_data.sql
