...
--11/16/2011 adding new investigation types
SELECT setval('investigation_type_id_seq', (SELECT MAX(id) FROM investigation_type)+1);
INSERT into investigation_type (label, definition) VALUES ('Remote Sensing', 'Investigations that involve the use of aerial or satellite sensor technologies to detect, describe, or classify objects on Earth (e.g. LIDAR, photographic, radar, or spectral methods).');
INSERT into investigation_type (label, definition) VALUES ('Geophysical Survey', 'Investigations that rely on ground-based instrument sensing techniques to create images and/or maps for archaeological research (e.g. magnetometry, resistivity, or ground penetrating radar).');
INSERT into investigation_type (label, definition) VALUES ('Heritage Management', 'Studies and plans related to managing or planning for the care, interpretation, preservation, or protection of archaeological resources, including collections, records, and sites.');
