...
app.controller('IntegrationController', [
        ...
        function($rootScope, $scope, $log, integration, dataService, validationService, $attrs, $timeout) {
             ...
             * @param kind
             *            the kind of message ('info', 'success', or error'error')
             */
             ...
             * @param promise
             * @param msgStart
             *            message to immediately display
             * @param msgDone
             *            message to display when promise resolves
             * @param [msgFail]
             *            message to display when promise rejects (default: "${msgStart} : failed")
             */
            self.promiseStatus = function(promise, msgStart, msgDone, msgFail) {
                ...
                promise.then(function() {
                    self.updateStatus(_msgDone, "success");
                }, function() {
                    self.updateStatus(_msgFail, "error");
                });
                return promise;
            }
            ...
            $scope.$on('dataReceived', function(e, name, jsonData) {
                ...
                self.promiseStatus(result, "Loading integration...", "Loading complete.",
            ...
            self.addDatasets = function(dataTableIds) {
                ...
                tableDetailsPromise.then(function(dataTables) {
                    ...
                    self.promiseStatus(participationPromise, "Loadng participation data", "Loading complete",
            ...
            /**
             * Return a compatible columns for an ontology, grouped by Dataset. The exact structure is a list of objects that contain a 'dataTable' property and
             * a 'compatCols' property
             */
             ...
             * adding an integration column before the app is loading ontology participation information. fixme: this should really just be a priority queue
             * (aka map of lists) that returns true when queue is empty.
             */
