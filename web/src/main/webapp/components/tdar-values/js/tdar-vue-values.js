var _value = Vue.component('value', {
    ...
    methods: {
        getLabel:function(choice, idx) {
            if (choice[this.labelField] == undefined) {
                return choice;
            }
            return choice[this.labelField];
        },
        getValue:function(choice, idx) {
            if (choice[this.valueField] == undefined) {
                return choice;
            }
            return choice[this.valueField];
