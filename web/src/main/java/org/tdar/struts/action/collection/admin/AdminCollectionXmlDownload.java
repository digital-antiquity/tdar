...
public class AdminCollectionXmlDownload extends TdarBaseActionSupport implements Preparable {
    ...
    public void prepare() throws Exception {
        ...
        File f = FILESTORE.getXmlRecordFile(FilestoreObjectType.COLLECTION, id, filename);
        if (!f.exists()) {
