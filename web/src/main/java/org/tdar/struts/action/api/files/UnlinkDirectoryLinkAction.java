...
@Namespace("/api/file")
public class UnlinkDirectoryLinkAction extends AbstractHasFileAction<TdarDir>{
    ...
    @Action(value = "unlinkDirCollection",
            interceptorRefs = { @InterceptorRef("editAuthenticatedStack") })
    @PostOnly
    @WriteableSession
    public String execute() throws IOException {
        personalFilestoreService.unlinkLinkedCollection(getFile(), getAuthenticatedUser());
