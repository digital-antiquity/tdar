...
public class InheritanceSeleniumWebITCase extends AbstractBasicSeleniumWebITCase {
    ...
    private void fillOUtProjectForm(WebDriver driver, Project project) {
        ...
        waitFor(By.id("metadataForm_resourceAnnotations_1__resourceAnnotationKey_key")).clear();
        ...
        driver.findElement(By.id("divIdentifiersAddAnotherButton")).click();
        waitFor(By.id("metadataForm_resourceAnnotations_2__resourceAnnotationKey_key")).clear();
        ...
        waitFor(By.id("metadataForm_geographicKeywords_0_")).sendKeys("geoterm1");
        driver.findElement(By.id("geographicKeywordsRepeatableAddAnotherButton")).click();
        waitFor(By.id("metadataForm_geographicKeywords_1_")).clear();
        driver.findElement(By.id("metadataForm_geographicKeywords_1_")).sendKeys("geoterm2");
        driver.findElement(By.id("geographicKeywordsRepeatableAddAnotherButton")).click();
        waitFor(By.id("metadataForm_geographicKeywords_2_")).clear();
        ...
        waitFor(By.id("metadataForm_investigationTypeIds9")).click();
        waitFor(By.id("metadataForm_investigationTypeIds20")).click();
        waitFor(By.id("metadataForm_approvedMaterialKeywordIds1")).click();
        waitFor(By.id("metadataForm_approvedMaterialKeywordIds8")).click();
        waitFor(By.id("metadataForm_approvedMaterialKeywordIds15")).click();
        waitFor(By.id("approvedCultureKeywordIds-1")).click();
        waitFor(By.id("approvedCultureKeywordIds-16")).click();
        waitFor(By.id("approvedCultureKeywordIds-22")).click();
        waitFor(By.id("metadataForm_uncontrolledCultureKeywords_0_")).clear();
        ...
        waitFor(By.id("metadataForm_sourceCollections_1__text")).clear();
        ...
        waitFor(By.id("metadataForm_relatedComparativeCollections_1__text")).clear();
        driver.findElement(By.id("metadataForm_relatedComparativeCollections_1__text")).sendKeys("relcoll2");
        driver.findElement(By.id("divRelatedComparativeCitationControlAddAnotherButton")).click();
        waitFor(By.id("metadataForm_relatedComparativeCollections_2__text")).clear();
