...
public class CollectionDocumentConverter extends AbstractSolrDocumentConverter {
    ...
    public static SolrInputDocument convert(ResourceCollection collection) {
        ...
        if (collection instanceof SharedCollection) {
            ...
            doc.setField(QueryFieldNames.COLLECTION_PARENT, shared.getParentId());
            doc.setField(QueryFieldNames.COLLECTION_PARENT_LIST, shared.getParentIds());
            doc.setField(QueryFieldNames.TOP_LEVEL, shared.isTopLevel());
