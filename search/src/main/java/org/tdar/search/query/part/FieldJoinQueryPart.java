...
public class FieldJoinQueryPart<T extends FieldQueryPart<?>> implements QueryPart<T> {
    ...
    public FieldJoinQueryPart(String innerFieldName, String outerFieldName, T part) {
